            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4><?php echo e(ucwords(trans('file.General Setting'))); ?></h4>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><?php echo e(ucwords(trans('file.System Title'))); ?> *</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><?php echo e(ucwords(trans('file.System Logo'))); ?> *</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><?php echo e(ucwords(trans('file.Currency'))); ?> *</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><?php echo e(ucwords(trans('file.Currency Position'))); ?> *</label><br>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><?php echo e(ucwords(trans('file.Time Zone'))); ?></label>
                                ...
                                <div class="col-md-6 d-none">
                                    <div class="form-group">
                                        <label><?php echo e(ucwords(trans('file.Theme'))); ?> *</label>
                                        <div class="row ml-1">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><?php echo e(ucwords(trans('file.Staff Access'))); ?> *</label>
                                        <?php if($lims_general_setting_data): ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><?php echo e(ucwords(trans('file.Invoice Format'))); ?> *</label>
                                        <?php if($lims_general_setting_data): ?>
                                ...
                                <div id="state" class="col-md-6 d-none">
                                    <div class="form-group">
                                        <label><?php echo e(ucwords(trans('file.State'))); ?> *</label>
                                        <?php if($lims_general_setting_data): ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><?php echo e(ucwords(trans('file.Date Format'))); ?> *</label>
                                        <?php if($lims_general_setting_data): ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><?php echo e(ucwords(trans('file.Developed By'))); ?></label>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/pos.halalexportindonesia.com/project-files/resources/views/setting/general_setting.blade.php ENDPATH**/ ?>