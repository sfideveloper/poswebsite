        ...
        <div class="row">
            <div class="col-md-12 text-right mb-4">
                <?php if(in_array("purchase-return-add", $all_permission)): ?>
                    <a href="<?php echo e(route('return-purchase.create')); ?>" class="btn btn-info p-3"><i class="dripicons-plus"></i> <?php echo e(trans('file.Add Return')); ?></a>
                <?php endif; ?>
            </div>
            <div class="col-md-12">
                <div class="card">
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                                    ...
                                                    <li>
                                                        <a href="<?php echo e(route('return-purchase.edit', $return->id)); ?>" class="btn btn-link"><i class="dripicons-document-edit"></i> <?php echo e(ucfirst(trans('file.edit'))); ?></a>
                                                    </li>
                                                    <?php endif; ?>
                                                    <li class="divider"></li>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/pos.halalexportindonesia.com/project-files/resources/views/return_purchase/index.blade.php ENDPATH**/ ?>