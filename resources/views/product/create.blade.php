                    ...
                    <div class="card-body">
                        ...
                        <form id="product-form">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>{{ucwords(trans('file.Product Tax'))}}</strong> </label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>{{ucwords(trans('file.Tax Method'))}}</strong> </label> <i class="dripicons-question" data-toggle="tooltip" title="{{trans('file.Exclusive: Poduct price = Actual product price + Tax. Inclusive: Actual product price = Product price - Tax')}}"></i>
                                ...
                                <div class="col-md-4 mt-3">
                                    ...
                                    <label><h5>{{ucwords(trans('file.Add Promotional Price'))}}</h5></label>
                                </div>
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-4" id="promotion_price">
                                            <label>{{ucwords(trans('file.Promotional Price'))}}</label>
                            ...
                            <div class="form-group text-right">
                                <input type="submit" value="{{ucfirst(trans('file.submit'))}}" class="btn btn-primary btn-md-block mt-3" id="submit-btn">
                            </div>
                        </form>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    function validate() {
        ...
        if(!(product_code.match(exp)) && (barcode_symbology == 'UPCA' || barcode_symbology == 'UPCE' || barcode_symbology == 'EAN8' || barcode_symbology == 'EAN13') ) {
            ...
            if(barcode_symbology == 'UPCA' && product_code.length > 12){
                alert('Product code length must be less than equal to 12');
                return false;
            }
            else if(barcode_symbology == 'EAN8' && product_code.length > 8){
                alert('Product code length must be less than equal to 8');
                return false;
            }
            else if(barcode_symbology == 'EAN13' && product_code.length > 13){
                alert('Product code length must be less than equal to 13');
                return false;
            }
        }
