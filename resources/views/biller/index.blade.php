        ...
        <div class="row">
            <div class="col-md-12 text-right mb-4">
                @if(in_array("billers-add", $all_permission))
                    <a href="{{route('biller.create')}}" class="btn btn-info p-3"><i class="dripicons-plus"></i> {{ucfirst(trans('file.Add Biller'))}}</a>&nbsp;
                    <a href="#" data-toggle="modal" data-target="#importbiller" class="btn btn-primary p-3"><i class="dripicons-copy"></i> {{ucfirst(trans('file.Import Biller'))}}</a>
                @endif
            </div>
            <div class="col-md-12">
                <div class="card">
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                                    ...
                                                    <li>
                                                        <a href="{{ route('biller.edit', $biller->id) }}" class="btn btn-link"><i class="dripicons-document-edit"></i> {{ucfirst(trans('file.edit'))}}</a> 
                                                    </li>
                                                    @endif
                                                    <li class="divider"></li>
    ...
    <div role="document" class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h5 id="exampleModalLabel" class="modal-title">{{ucwords(trans('file.Import Biller'))}}</h5>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <a href="sample_file/sample_biller.csv" class="btn btn-info btn-block btn-md"><i class="dripicons-download"></i> {{ucfirst(trans('file.Download'))}}</a>
                    </div>
                </div>
            </div>
