    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header mt-2">
                <h3 class="text-center"><?php echo e(ucwords(trans('file.Product Report'))); ?></h3>
            </div>
        ...
        <table id="report-table" class="table table-hover">
            <thead>
                <tr>
                    ...
                    <th><?php echo e(ucfirst(trans('file.Product Name'))); ?></th>
                    <th><?php echo e(ucfirst(trans('file.Purchased Amount'))); ?></th>
                    <th><?php echo e(ucfirst(trans('file.Purchased'))); ?> <?php echo e(ucfirst(trans('file.qty'))); ?></th>
                    <th><?php echo e(ucfirst(trans('file.Sold Amount'))); ?></th>
                    <th><?php echo e(ucfirst(trans('file.Sold'))); ?> <?php echo e(ucfirst(trans('file.qty'))); ?></th>
                    <th><?php echo e(ucfirst(trans('file.profit'))); ?></th>
                    <th><?php echo e(ucfirst(trans('file.In Stock'))); ?></th>
                </tr>
            </thead>
            <tbody>
                <?php if(!empty($product_name)): ?>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u5070271/files-urekapos/resources/views/report/product_report.blade.php ENDPATH**/ ?>