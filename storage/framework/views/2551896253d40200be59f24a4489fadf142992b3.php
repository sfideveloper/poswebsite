        ...
        <div class="row">
            <div class="col-md-12 text-right mb-4">
                <?php if(in_array("expenses-add", $all_permission)): ?>
                    <button class="btn btn-info p-3" data-toggle="modal" data-target="#expense-modal"><i class="dripicons-plus"></i> <?php echo e(ucfirst(trans('file.Add Expense'))); ?></button>
                <?php endif; ?>
            </div>
            <div class="col-md-12">
                <div class="card">
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                                    ...
                                                    <li><button type="button" data-id="<?php echo e($expense->id); ?>" class="open-Editexpense_categoryDialog btn btn-link" data-toggle="modal" data-target="#editModal"><i class="dripicons-document-edit"></i> <?php echo e(ucfirst(trans('file.edit'))); ?></button></li>
                                                    <?php endif; ?>
    ...
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 id="exampleModalLabel" class="modal-title"><?php echo e(ucwords(trans('file.Update Expense'))); ?></h5>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/pos.halalexportindonesia.com/project-files/resources/views/expense/index.blade.php ENDPATH**/ ?>