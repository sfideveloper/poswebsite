            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header mt-2">
                	    <h4 class=""><?php echo e(ucwords(trans('file.Product Quantity Alert'))); ?></h4>
                    </div>
                    <div class="card-body">
                            ...
                            <table id="report-table" class="table table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo e(ucfirst(trans('file.Product Code'))); ?></th>
                                        <th><?php echo e(ucfirst(trans('file.Quantity'))); ?></th>
                                        <th><?php echo e(ucfirst(trans('file.Alert Quantity'))); ?></th>
                                    </tr>
                                </thead>
                                <tbody>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/pos.halalexportindonesia.com/project-files/resources/views/report/qty_alert_report.blade.php ENDPATH**/ ?>