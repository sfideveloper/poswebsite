    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header mt-2">
                <h3 class="text-center">{{ucwords(trans('file.User Report'))}}</h3>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-4 mt-3">
                    <div class="form-group row">
                        <label class="d-tc mt-2"><strong>{{ucwords(trans('file.Choose User'))}}</strong> &nbsp;</label>
                        <div class="d-tc">
                ...
                <table id="purchase-table" class="table table-hover">
                    <thead>
                        <tr>
                            ...
                            <th>{{ucfirst(trans('file.product'))}} ({{ucfirst(trans('file.qty'))}})</th>
                            <th>{{ucfirst(trans('file.grand total'))}}</th>
                            <th>{{ucfirst(trans('file.Paid Amount'))}}</th>
                            <th>{{ucfirst(trans('file.Due'))}}</th>
                            <th>{{ucfirst(trans('file.Status'))}}</th>
                        </tr>
                    </thead>
                ...
                <table id="payment-table" class="table table-hover">
                    <thead>
                        <tr>
                            ...
                            <th>{{ucfirst(trans('file.Paid Method'))}}</th>
                        </tr>
                    </thead>
                    <tbody>
