    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 text-right mb-4">
                <a href="{{route('qty_adjustment.create')}}" class="btn btn-info p-3"><i class="dripicons-plus"></i> {{ucfirst(trans('file.Add Adjustment'))}}</a>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                                    <li>
                                                        <a href="{{ route('qty_adjustment.edit', $adjustment->id) }}" class="btn btn-link"><i class="dripicons-document-edit"></i> {{ucfirst(trans('file.edit'))}}</a> 
                                                    </li>
                                                    <li class="divider"></li>
