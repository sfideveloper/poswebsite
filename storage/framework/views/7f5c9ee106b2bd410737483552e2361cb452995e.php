...
<section class="forms">
    <div class="container-fluid">
        <div class="card">
            <div class="card-header mt-2">
                <h3 class="text-center"><?php echo e(ucwords(trans('file.Tax Report'))); ?></h3>
            </div>
    ...
    <ul class="nav nav-tabs ml-4 mt-3" role="tablist">
        <li class="nav-item">
            <a class="nav-link active" href="#warehouse-tax" role="tab" data-toggle="tab"><?php echo e(trans('file.Tax')); ?></a>
        </li>
        <li class="nav-item">
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel project\posweb\resources\views/report/tax_report.blade.php ENDPATH**/ ?>