        ...
        <div class="row">
            <div class="col-md-12 text-right mb-4">
                <?php if(in_array("purchases-add", $all_permission)): ?>
                    <a href="<?php echo e(route('purchases.create')); ?>" class="btn btn-info p-3"><i class="dripicons-plus"></i> <?php echo e(ucfirst(trans('file.Add Purchase'))); ?></a>&nbsp;
                    <a href="<?php echo e(url('purchases/purchase_by_csv')); ?>" class="btn btn-primary p-3"><i class="dripicons-copy"></i> <?php echo e(ucfirst(trans('file.Import Purchase'))); ?></a>
                <?php endif; ?>
            </div>
            <div class="col-md-12">
                <div class="card">
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/muqtadirulmajid/Development/Laravel/eksternal_project/poswebsite/resources/views/purchase/index.blade.php ENDPATH**/ ?>