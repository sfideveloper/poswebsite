                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form id="product-form">
                            ...
                            <div class="form-group">
                                <input type="button" value="<?php echo e(ucfirst(trans('file.submit'))); ?>" id="submit-btn" class="btn btn-primary">
                            </div>
                        </form>
                    </div>
                </div>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u5070271/files-urekapos/resources/views/product/create.blade.php ENDPATH**/ ?>