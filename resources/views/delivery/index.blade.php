                            ...
                            <table id="delivery-table" class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th>{{ucfirst(trans('file.Delivery Reference'))}}</th>
                                        <th>{{ucfirst(trans('file.Sale Reference'))}}</th>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                                    <li>
                                                        <button type="button" data-id="{{$delivery->id}}" class="open-EditCategoryDialog btn btn-link"><i class="dripicons-document-edit"></i> {{ucfirst(trans('file.edit'))}}</button>
                                                    </li>
                                                    <li class="divider"></li>
        ...
        <div class="container mt-3 pb-2 border-bottom">
            <div class="row">
                ...
                <div class="col-md-12 text-center">
                    <i style="font-size: 15px;">{{ucwords(trans('file.Delivery Details'))}}</i>
                </div>
            </div>
        </div>
    ...
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 id="exampleModalLabel" class="modal-title">{{ucwords(trans('file.Update Delivery'))}}</h5>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mt-2 form-group">
                        <label>{{ucwords(trans('file.Recieved By'))}}</label>
