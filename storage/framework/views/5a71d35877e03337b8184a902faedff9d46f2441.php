            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header mt-2">
                        <h3 class="text-center"><?php echo e(ucwords(trans('file.Sale Report'))); ?></h3>
                    </div>
                    <div class="card-body">
                            ...
                            <table id="report-table" class="table table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo e(ucfirst(trans('file.Sold Qty'))); ?></th>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/muqtadirulmajid/Development/Laravel/poswebsite/resources/views/report/sale_report.blade.php ENDPATH**/ ?>