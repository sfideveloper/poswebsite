                ...
                <div class="card">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-4 mt-3">
                            <div class="form-group row">
                                <label class="d-tc mt-2"><strong><?php echo e(ucwords(trans('file.Choose Customer'))); ?></strong> &nbsp;</label>
                                <div class="d-tc">
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel project\poswebsite\resources\views/report/customer_report.blade.php ENDPATH**/ ?>