            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4><?php echo e(ucwords(trans('file.HRM Setting'))); ?></h4>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><?php echo e(ucwords(trans('file.Default CheckIn'))); ?> *</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><?php echo e(ucwords(trans('file.Default CheckOut'))); ?></label>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u5070271/files-urekapos/resources/views/setting/hrm_setting.blade.php ENDPATH**/ ?>