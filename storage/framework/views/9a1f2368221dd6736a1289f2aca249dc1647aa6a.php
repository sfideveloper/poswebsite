...
<section>
    ...
    <div class="container-fluid">
        <a href="<?php echo e(route('employees.create')); ?>" class="btn btn-info"><i class="dripicons-plus"></i> <?php echo e(ucfirst(trans('file.Add Employee'))); ?></a>
    </div>
    <?php endif; ?>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                ...
                                <li>
                                    <button type="button" data-id="<?php echo e($employee->id); ?>" data-name="<?php echo e($employee->name); ?>" data-email="<?php echo e($employee->email); ?>" data-phone_number="<?php echo e($employee->phone_number); ?>" data-department_id="<?php echo e($employee->department_id); ?>" data-address="<?php echo e($employee->address); ?>" data-city="<?php echo e($employee->city); ?>" data-country="<?php echo e($employee->country); ?>" class="edit-btn btn btn-link" data-toggle="modal" data-target="#editModal"><i class="dripicons-document-edit"></i> <?php echo e(ucfirst(trans('file.edit'))); ?></button> 
                                </li>
                                <?php endif; ?>
                                <li class="divider"></li>
    ...
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 id="exampleModalLabel" class="modal-title"><?php echo e(ucwords(trans('file.Update Employee'))); ?></h5>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u5070271/files-urekapos/resources/views/employee/index.blade.php ENDPATH**/ ?>