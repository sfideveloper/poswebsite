            ...
            <div class="col-md-12">
				<div class="card">
						<div class="card-header d-flex align-items-center">
							<h4><?php echo e(ucwords(trans('file.Group Permission'))); ?></h4>
						</div>
						...
						<div class="card-body">
							...
							<div class="table-responsive">
								<table class="table table-bordered permission-table">
									...
									<tr>
										<th class="text-center"><?php echo e(ucfirst(trans('file.View'))); ?></th>
										<th class="text-center"><?php echo e(ucfirst(trans('file.add'))); ?></th>
										<th class="text-center"><?php echo e(ucfirst(trans('file.edit'))); ?></th>
										<th class="text-center"><?php echo e(ucfirst(trans('file.delete'))); ?></th>
									</tr>
									</thead>
									<tbody>
									<tr>
											...
											<span>
												<div aria-checked="false" aria-disabled="false">
													<div class="checkbox">
														...
														<?php endif; ?>
														<label for="biller-report" class="padding05"><?php echo e(trans('file.Biller Report')); ?> &nbsp;&nbsp;</label>
													</div>
												</div>
											</span>
											<span>
												<div aria-checked="false" aria-disabled="false">
													<div class="checkbox">
														<?php if(in_array("tax-report", $all_permission)): ?>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel project\poswebsite\resources\views/role/permission.blade.php ENDPATH**/ ?>