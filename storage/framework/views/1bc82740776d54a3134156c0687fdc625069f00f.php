...
<section>
    <div class="container-fluid">
        ...
        <button type="button" class="btn btn-info" data-toggle="modal" data-target="#createModal"><i class="dripicons-plus"></i> <?php echo e(ucfirst(trans("file.Add Category"))); ?></button>&nbsp;
        <button class="btn btn-primary" data-toggle="modal" data-target="#importCategory"><i class="dripicons-copy"></i> <?php echo e(ucfirst(trans('file.Import Category'))); ?></button>
    </div>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u5070271/files-urekapos/resources/views/category/create.blade.php ENDPATH**/ ?>