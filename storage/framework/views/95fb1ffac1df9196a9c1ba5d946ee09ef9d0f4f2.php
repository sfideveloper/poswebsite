            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4><?php echo e(ucwords(trans('file.POS Setting'))); ?></h4>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><?php echo e(ucwords(trans('file.Default Customer'))); ?> *</label>
                                    ...
                                    <div class="form-group">
                                        <label><?php echo e(ucwords(trans('file.Default Biller'))); ?> *</label>
                                        <?php if($lims_pos_setting_data): ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><?php echo e(ucwords(trans('file.Default Warehouse'))); ?> *</label>
                                        <?php if($lims_pos_setting_data): ?>
                                    ...
                                    <div class="form-group">
                                        <label><?php echo e(ucwords(trans('file.Displayed Number of Product Row'))); ?> *</label>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/pos.halalexportindonesia.com/project-files/resources/views/setting/pos_setting.blade.php ENDPATH**/ ?>