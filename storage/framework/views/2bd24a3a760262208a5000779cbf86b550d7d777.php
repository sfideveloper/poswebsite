...
<section>
    <div class="container-fluid">
        <button class="btn btn-info" data-toggle="modal" data-target="#create-money-transfer-modal"><i class="dripicons-plus"></i> <?php echo e(ucfirst(trans('file.Add Money Transfer'))); ?></button>
    </div>
        ...
        <table id="money-transfer-table" class="table">
            <thead>
                <tr>
                    ...
                    <th><?php echo e(ucfirst(trans('file.From Account'))); ?></th>
                    <th><?php echo e(ucfirst(trans('file.To Account'))); ?></th>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                <li><button type="button" id="edit-btn" data-id="<?php echo e($money_transfer->id); ?>" data-from_id="<?php echo e($money_transfer->from_account_id); ?>" data-to_id="<?php echo e($money_transfer->to_account_id); ?>" data-amount="<?php echo e($money_transfer->amount); ?>"  class=" btn btn-link" data-toggle="modal" data-target="#edit-money-transfer-modal"><i class="dripicons-document-edit"></i> <?php echo e(ucfirst(trans('file.edit'))); ?></button></li>
                                <li class="divider"></li>
    ...
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 id="exampleModalLabel" class="modal-title"><?php echo e(ucwords(trans('file.Add Money Transfer'))); ?></h5>
                ...
                <?php echo Form::open(['route' => 'money-transfers.store', 'method' => 'post']); ?>
                  ...
                  <div class="row">
                      <div class="col-md-6 form-group">
                          <label><?php echo e(ucwords(trans('file.From Account'))); ?> *</label>
                      ...
                      <div class="col-md-6 form-group">
                          <label><?php echo e(ucwords(trans('file.To Account'))); ?> *</label>
...
<div id="edit-money-transfer-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 id="exampleModalLabel" class="modal-title"><?php echo e(ucwords(trans('file.Update Money Transfer'))); ?></h5>
                <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
            </div>
            <div class="modal-body">
                <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u5070271/files-urekapos/resources/views/money_transfer/index.blade.php ENDPATH**/ ?>