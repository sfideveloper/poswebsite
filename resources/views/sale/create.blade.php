            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4>{{ucwords(trans('file.Add Sale'))}}</h4>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>{{ucwords(trans('file.Attach Document'))}}</label> <i class="dripicons-question" data-toggle="tooltip" title="Only jpg, jpeg, png, gif, pdf, csv, docx, xlsx and txt file is supported"></i>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <button type="button" name="update_btn" class="btn btn-primary">{{ucfirst(trans('file.update'))}}</button>
                    </form>
                </div>
            </div>
        </div>
              ...
              <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
                <div class="row">
                  ...
                  <div class="col-md-12 form-group">
                      <button type="submit" class="btn btn-primary">{{ucfirst(trans('file.submit'))}}</button>
                  </div>
                </div>
            </div>
            {{ Form::close() }}
