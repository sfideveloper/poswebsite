            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header mt-2">
                        <h3 class="text-center"><?php echo e(ucwords(trans('file.Payment Report'))); ?></h3>
                    </div>
                    <div class="card-body">
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel project\poswebsite\resources\views/report/payment_report.blade.php ENDPATH**/ ?>