            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4>{{ucwords(trans('file.Create SMS'))}}</h4>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group twilio">
                                        <label>{{ucwords(trans('file.Mobile'))}} *</label>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group text-right">
                                        <button type="submit" class="btn btn-primary btn-md-block"><i class="fa fa-paper-plane"></i> {{ucfirst(trans('file.Send SMS'))}}</button> 
                                    </div>
                                </div>
                            </div>
                        {!! Form::close() !!}
