        ...
        <div class="container-fluid">
          <div class="col-md-12">
            <div class="brand-text float-left mt-4">
                <h3><?php echo e(ucwords(trans('file.welcome'))); ?> <span><?php echo e(Auth::user()->name); ?></span> </h3>
            </div>
              ...
              <div class="row">
                ...
                <div class="col-sm-3">
                  <div class="wrapper count-title text-center">
                    <div class="icon"><i class="dripicons-graph-bar" style="color: #964aad"></i></div>
                    <div class="name"><strong style="color: #964aad"><?php echo e(ucfirst(trans('file.revenue'))); ?></strong></div>
                    <div class="count-number revenue-data"><?php echo e($currency->code); ?> <?php echo e(number_format((float)$revenue, 2, '.', '')); ?></div>
                  </div>
                </div>
                <!-- Count item widget-->
                <div class="col-sm-3">
                  <div class="wrapper count-title text-center">
                    <div class="icon"><i class="dripicons-return" style="color: #EC992F"></i></div>
                    <div class="name"><strong style="color: #EC992F"><?php echo e(ucfirst(trans('file.Sale Return'))); ?></strong></div>
                    <div class="count-number return-data"><?php echo e($currency->code); ?> <?php echo e(number_format((float)$return, 2, '.', '')); ?></div>
                  </div>
                </div>
                <!-- Count item widget-->
                <div class="col-sm-3">
                  <div class="wrapper count-title text-center">
                    <div class="icon"><i class="dripicons-media-loop" style="color: #00c646"></i></div>
                    <div class="name"><strong style="color: #00c646"><?php echo e(ucfirst(trans('file.Purchase Return'))); ?></strong></div>
                    <div class="count-number purchase_return-data"><?php echo e($currency->code); ?> <?php echo e(number_format((float)$purchase_return, 2, '.', '')); ?></div>
                  </div>
                </div>
                <!-- Count item widget-->
                <div class="col-sm-3">
                  <div class="wrapper count-title text-center">
                    ...
                    <div class="name"><strong style="color: #297ff9"><?php echo e(ucfirst(trans('file.profit'))); ?></strong></div>
                    <div class="count-number profit-data"><?php echo e($currency->code); ?> <?php echo e(number_format((float)$profit, 2, '.', '')); ?></div>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                  ...
                  <div class="right-column">
                    <div class="badge badge-primary"><?php echo e(ucfirst(trans('file.latest'))); ?> 5</div>
                  </div>
                </div>
            ...
            <div class="col-md-5">
              <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                  ...
                  <div class="right-column">
                    <div class="badge badge-primary"><?php echo e(ucfirst(trans('file.top'))); ?> 5</div>
                  </div>
                </div>
                <div class="table-responsive">
                    <table class="table">
...
<script type="text/javascript">
    ...
    function dashboardFilter(data){
        $('.revenue-data').hide();
        $('.revenue-data').html(`${currency.code} ${parseFloat(data[0]).toFixed(2)}`);
        $('.revenue-data').show(500);

        $('.return-data').hide();
        $('.return-data').html(`${currency.code} ${parseFloat(data[1]).toFixed(2)}`);
        $('.return-data').show(500);

        $('.profit-data').hide();
        $('.profit-data').html(`${currency.code} ${parseFloat(data[2]).toFixed(2)}`);
        $('.profit-data').show(500);

        $('.purchase_return-data').hide();
        $('.purchase_return-data').html(`${currency.code} ${parseFloat(data[3]).toFixed(2)}`);
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u5070271/files-urekapos/resources/views/index.blade.php ENDPATH**/ ?>