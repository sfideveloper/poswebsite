                    ...
                    <div class="col-md-7">
                        <div class="">
                            ...
                            <div class="payment-options">
                                ...
                                <div class="column-5">
                                    <button style="background-color: #b33771" type="button" class="btn btn-custom payment-btn text-white" data-toggle="modal" data-target="#add-payment" id="deposit-btn"><i class="fa fa-university"></i> Deposit</button>
                                </div>
                                <!-- <div class="column-5">
...
<?php echo $__env->make('layout.top-head', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Redesign Ureka\resources\views/sale/pos.blade.php ENDPATH**/ ?>