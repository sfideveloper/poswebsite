...
<section>
    <div class="container-fluid">
        ...
        <a href="<?php echo e(route('biller.create')); ?>" class="btn btn-info"><i class="dripicons-plus"></i> <?php echo e(ucfirst(trans('file.Add Biller'))); ?></a>&nbsp;
        <a href="#" data-toggle="modal" data-target="#importbiller" class="btn btn-primary"><i class="dripicons-copy"></i> <?php echo e(ucfirst(trans('file.Import Biller'))); ?></a>
        <?php endif; ?>
    </div>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                ...
                                <li>
                                    <a href="<?php echo e(route('biller.edit', $biller->id)); ?>" class="btn btn-link"><i class="dripicons-document-edit"></i> <?php echo e(ucfirst(trans('file.edit'))); ?></a> 
                                </li>
                                <?php endif; ?>
                                <li class="divider"></li>
    ...
    <div role="document" class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h5 id="exampleModalLabel" class="modal-title"><?php echo e(ucwords(trans('file.Import Biller'))); ?></h5>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <a href="sample_file/sample_biller.csv" class="btn btn-info btn-block btn-md"><i class="dripicons-download"></i> <?php echo e(ucfirst(trans('file.Download'))); ?></a>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u5070271/files-urekapos/resources/views/biller/index.blade.php ENDPATH**/ ?>