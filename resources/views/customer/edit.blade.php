            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4>{{ucwords(trans('file.Update Customer'))}}</h4>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>{{ucwords(trans('file.Company Name'))}} </label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>{{ucwords(trans('file.Tax Number'))}}</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>{{ucwords(trans('file.State'))}}</label>
                                    <input type="text" name="state" value="{{$lims_customer_data->state}}" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>{{ucwords(trans('file.Postal Code'))}}</label>
                            ...
                            <div class="col-md-6 mt-3">
                                <div class="form-group">
                                    <label>{{ucwords(trans('file.Add User'))}}</label>&nbsp;
                            ...
                            <div class="col-md-6 user-input">
                                <div class="form-group">
                                    <label>{{ucwords(trans('file.UserName'))}} *</label>
                            ...
                            <div class="col-md-6 user-input">
                                <div class="form-group">
                                    <label>{{ucwords(trans('file.Password'))}} *</label>
