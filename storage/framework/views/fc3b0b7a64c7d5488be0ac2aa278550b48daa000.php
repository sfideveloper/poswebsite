        ...
        <div class="row">
            <div class="col-md-12 text-right mb-4">
                <?php if(in_array("billers-add", $all_permission)): ?>
                    <a href="<?php echo e(route('biller.create')); ?>" class="btn btn-info p-3"><i class="dripicons-plus"></i> <?php echo e(ucfirst(trans('file.Add Biller'))); ?></a>&nbsp;
                    <a href="#" data-toggle="modal" data-target="#importbiller" class="btn btn-primary p-3"><i class="dripicons-copy"></i> <?php echo e(ucfirst(trans('file.Import Biller'))); ?></a>
                <?php endif; ?>
            </div>
            <div class="col-md-12">
                <div class="card">
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/pos.halalexportindonesia.com/project-files/resources/views/biller/index.blade.php ENDPATH**/ ?>