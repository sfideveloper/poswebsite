            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header mt-3">
                        <h3 class="text-center">{{ucwords(trans('file.Product Report'))}}</h3>
                    </div>
                    <div class="card-body">
                            ...
                            <table id="report-table" class="table table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th>{{ucfirst(trans('file.Purchased Amount'))}}</th>
                                        <th>{{ucfirst(trans('file.Purchased'))}} {{ucfirst(trans('file.qty'))}}</th>
                                        <th>{{ucfirst(trans('file.Sold Amount'))}}</th>
                                        <th>{{ucfirst(trans('file.Sold'))}} {{ucfirst(trans('file.qty'))}}</th>
                                        <th>{{ucfirst(trans('file.profit'))}}</th>
                                        <th>{{ucfirst(trans('file.In Stock'))}}</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @if(!empty($product_name))
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$sold_qty}}</td>
                                        <td>{{"Rp " . number_format((float)$profit, 2, ',', '.')}}</td>
