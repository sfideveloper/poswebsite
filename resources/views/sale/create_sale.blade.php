                                ...
                                <div class="form-group">
                                    <div class="table-responsive">
                                        <table id="myTable" class="table table-hover table-striped order-list table-fixed">
                                            <thead>
                                                <tr>
                                                    <th class="col-sm-4">{{ufirst(trans('file.product'))}}</th>
                                                    <th class="col-sm-2">{{ufirst(trans('file.Price'))}}</th>
                                                    <th class="col-sm-3">{{ufirst(trans('file.Quantity'))}}</th>
                                                    <th class="col-sm-2">{{ufirst(trans('file.Subtotal'))}}</th>
                ...
                <div role="document" class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <button type="button" name="order_discount_btn" class="btn btn-primary" data-dismiss="modal">{{ucfirst(trans('file.submit'))}}</button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div role="document" class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <button type="button" class="btn btn-primary coupon-check" data-dismiss="modal">{{ucfirst(trans('file.submit'))}}</button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div role="document" class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <button type="button" name="order_tax_btn" class="btn btn-primary" data-dismiss="modal">{{ucfirst(trans('file.submit'))}}</button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div role="document" class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <button type="button" name="shipping_cost_btn" class="btn btn-primary" data-dismiss="modal">{{ucfirst(trans('file.submit'))}}</button>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-10">
                                    ...
                                    <div class="mt-3">
                                        <button id="submit-btn" type="submit" class="btn btn-primary">{{ucfirst(trans('file.submit'))}}</button>
                                    </div>
                                </div>
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
                        ...
                        <div class="form-group">
                        <input type="hidden" name="pos" value="1">      
                          <input type="submit" value="{{ucfirst(trans('file.submit'))}}" class="btn btn-primary">
                        </div>
                    </div>
                    {{ Form::close() }}
                  </div>
