            ...
            <div class="col-md-12">
				<div class="card">
						<div class="card-header d-flex align-items-center">
							<h4>{{ucwords(trans('file.Group Permission'))}}</h4>
						</div>
						...
						<div class="card-body">
							...
							<div class="table-responsive">
								<table class="table table-bordered permission-table">
									...
									<tr>
										<th class="text-center">{{ucfirst(trans('file.View'))}}</th>
										<th class="text-center">{{ucfirst(trans('file.add'))}}</th>
										<th class="text-center">{{ucfirst(trans('file.edit'))}}</th>
										<th class="text-center">{{ucfirst(trans('file.delete'))}}</th>
									</tr>
									</thead>
									<tbody>
									<tr>
