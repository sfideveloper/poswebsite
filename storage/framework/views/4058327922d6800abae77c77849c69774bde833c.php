            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4><?php echo e(ucwords(trans('file.Add Customer'))); ?></h4>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label><?php echo e(ucwords(trans('file.Company Name'))); ?></label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label><?php echo e(ucwords(trans('file.Tax Number'))); ?></label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label><?php echo e(ucwords(trans('file.Postal Code'))); ?></label>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/pos.halalexportindonesia.com/project-files/resources/views/customer/create.blade.php ENDPATH**/ ?>