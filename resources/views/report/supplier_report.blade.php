    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header mt-2">
                <h3 class="text-center">{{ucwords(trans('file.Supplier Report'))}}</h3>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-4 mt-3">
                    <div class="form-group row">
                        <label class="d-tc mt-2"><strong>{{ucwords(trans('file.Choose Supplier'))}}</strong> &nbsp;</label>
                        <div class="d-tc">
                ...
                <table id="payment-table" class="table table-hover">
                    <thead>
                        <tr>
                            ...
                            <th>{{ucfirst(trans('file.Date'))}}</th>
                            <th>{{ucfirst(trans('file.Payment Reference'))}}</th>
                            <th>{{ucfirst(trans('file.Purchase Reference'))}}</th>
