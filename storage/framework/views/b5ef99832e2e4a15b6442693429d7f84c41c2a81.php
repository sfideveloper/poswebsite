    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 text-right mb-4">
                <button class="btn btn-info p-3" data-toggle="modal" data-target="#createModal"><i class="dripicons-plus"></i> <?php echo e(ucfirst(trans('file.Add Currency'))); ?> </button>&nbsp;
            </div>
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                            ...
                            <table id="currency-table" class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo e(ucfirst(trans('file.Currency Name'))); ?></th>
                                        <th><?php echo e(ucfirst(trans('file.Currency Code'))); ?></th>
                                        <th><?php echo e(ucfirst(trans('file.Exchange Rate'))); ?></th>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                                    <li><button type="button" data-id="<?php echo e($currency->id); ?>" data-name="<?php echo e($currency->name); ?>" data-code="<?php echo e($currency->code); ?>" data-exchange_rate="<?php echo e($currency->exchange_rate); ?>" class="edit-btn btn btn-link" data-toggle="modal" data-target="#editModal"><i class="dripicons-document-edit"></i> <?php echo e(ucfirst(trans('file.edit'))); ?></button></li>
                                                    <li class="divider"></li>
    ...
    <div role="document" class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h5 id="exampleModalLabel" class="modal-title"><?php echo e(ucwords(trans('file.Add Currency'))); ?></h5>
        ...
        <div class="modal-body">
          <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
            ...
            <div class="form-group">
                <label><?php echo e(ucwords(trans('file.Exchange Rate'))); ?> *</label>
...
<div id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
  <div role="document" class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h5 id="exampleModalLabel" class="modal-title"> <?php echo e(ucwords(trans('file.Update Currency'))); ?></h5>
        <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
      </div>
      <div class="modal-body">
          <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/pos.halalexportindonesia.com/project-files/resources/views/currency/index.blade.php ENDPATH**/ ?>