            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4>{{ucwords(trans('file.General Setting'))}}</h4>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>{{ucwords(trans('file.System Title'))}} *</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>{{ucwords(trans('file.System Logo'))}} *</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>{{ucwords(trans('file.Currency'))}} *</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>{{ucwords(trans('file.Currency Position'))}} *</label><br>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>{{ucwords(trans('file.Time Zone'))}}</label>
                                ...
                                <div class="col-md-6 d-none">
                                    <div class="form-group">
                                        <label>{{ucwords(trans('file.Theme'))}} *</label>
                                        <div class="row ml-1">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>{{ucwords(trans('file.Staff Access'))}} *</label>
                                        @if($lims_general_setting_data)
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>{{ucwords(trans('file.Invoice Format'))}} *</label>
                                        @if($lims_general_setting_data)
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>{{ucwords(trans('file.Date Format'))}} *</label>
                                        @if($lims_general_setting_data)
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>{{ucwords(trans('file.Developed By'))}}</label>
