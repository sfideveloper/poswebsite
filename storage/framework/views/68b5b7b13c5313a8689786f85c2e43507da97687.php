    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 text-right">
                ...
                <button type="button" class="btn btn-info p-3 mb-3" data-toggle="modal" data-target="#createModal"><i class="dripicons-plus"></i> <?php echo e(ucfirst(trans("file.Add Category"))); ?></button>&nbsp;
                <button class="btn btn-primary p-3 mb-3" data-toggle="modal" data-target="#importCategory"><i class="dripicons-copy"></i> <?php echo e(ucfirst(trans('file.Import Category'))); ?></button>
            </div>
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                            ...
                            <table id="category-table" class="table" style="width: 100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo e(ucfirst(trans('file.Parent Category'))); ?></th>
                                        <th><?php echo e(ucfirst(trans('file.Number of Product'))); ?></th>
                                        <th><?php echo e(ucfirst(trans('file.Stock Quantity'))); ?></th>
                                        <th><?php echo e(ucfirst(trans('file.Stock Worth (Price/Cost)'))); ?></th>
    ...
    <div role="document" class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h5 id="exampleModalLabel" class="modal-title"><?php echo e(ucwords(trans('file.Add Category'))); ?></h5>
        ...
        <div class="modal-body">
          <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
            <div class="row">
                ...
                <div class="col-md-6 form-group">
                    <label><?php echo e(ucwords(trans('file.Parent Category'))); ?></label>
...
<div id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
  <div role="document" class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h5 id="exampleModalLabel" class="modal-title"><?php echo e(ucwords(trans('file.Update Category'))); ?></h5>
        <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
      </div>
      <div class="modal-body">
        <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
...
<div id="importCategory" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h5 id="exampleModalLabel" class="modal-title"><?php echo e(ucwords(trans('file.Import Category'))); ?></h5>
          <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
        </div>
        <div class="modal-body">
            <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/pos.halalexportindonesia.com/project-files/resources/views/category/create.blade.php ENDPATH**/ ?>