                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" id="product-form" action="<?php echo e(route('products.updateProduct', $lims_product_data->id)); ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="button" value="<?php echo e(ucfirst(trans('file.submit'))); ?>" class="btn btn-primary" id="submit-btn">
                                    </div>
                                </div>
                            </div>
                        </form>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u5070271/files-urekapos/resources/views/product/edit.blade.php ENDPATH**/ ?>