        ...
        <div class="side-navbar-wrapper">
          ...
          <div class="main-menu">
            <ul id="side-main-menu" class="side-menu list-unstyled">
              <li><a href="<?php echo e(url('/')); ?>"> <i class="dripicons-device-desktop"></i><span><?php echo e(__('file.dashboard')); ?></span></a></li>
               <?php
              ...
              <li><a href="#product" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-tags"></i><span><?php echo e(__('file.product')); ?></span><span></a>
            ...
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              ...
              <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                ...
                <?php if(\Auth::user()->role_id <= 2): ?>
                  <li class="nav-item"><a href="<?php echo e(route('cashRegister.index')); ?>" title="<?php echo e(trans('file.Cash Register List')); ?>"><i class="dripicons-briefcase"></i></a></li>
                <?php endif; ?>
                <?php if($product_qty_alert_active): ?>
                  ...
                  <li class="nav-item" id="notification-icon">
                        ...
                        <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default notifications" user="menu">
                            <li class="notifications">
                              <a href="<?php echo e(route('report.qtyAlert')); ?>" class="btn btn-link"> <?php echo e($alert_product); ?> peringatan kuantitas stok</a>
                            </li>
                ...
                <?php endif; ?>
                <li class="nav-item">
                      <a rel="nofollow" data-target="#" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-item"><i class="dripicons-web"></i> <span><?php echo e(ucfirst(__('file.language'))); ?></span> <i class="fa fa-angle-down"></i></a>
                ...
                <?php if(Auth::user()->role_id != 5): ?>
                <li class="nav-item"> 
                    <a class="dropdown-item" href="<?php echo e(url('read_me')); ?>" target="_blank"><i class="dripicons-information"></i> <?php echo e(ucfirst(trans('file.Help'))); ?></a>
                </li>
                <?php endif; ?>
                <li class="nav-item">
                  ...
                  <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                      <li> 
                        <a href="<?php echo e(route('user.profile', ['id' => Auth::id()])); ?>"><i class="dripicons-user"></i> <?php echo e(ucfirst(trans('file.profile'))); ?></a>
                      </li>
                      <?php if($general_setting_permission_active): ?>
                      <li> 
                        <a href="<?php echo e(route('setting.general')); ?>"><i class="dripicons-gear"></i> <?php echo e(ucfirst(trans('file.settings'))); ?></a>
                      </li>
                      <?php endif; ?>
                      <li> 
                        <a href="<?php echo e(url('my-transactions/'.date('Y').'/'.date('m'))); ?>"><i class="dripicons-swap"></i> <?php echo e(ucfirst(trans('file.My Transaction'))); ?></a>
                      </li>
                      <?php if(Auth::user()->role_id != 5): ?>
                      <li> 
                        <a href="<?php echo e(url('holidays/my-holiday/'.date('Y').'/'.date('m'))); ?>"><i class="dripicons-vibrate"></i> <?php echo e(ucfirst(trans('file.My Holiday'))); ?></a>
                      </li>
                      <?php endif; ?>
                      <?php if($empty_database_permission_active): ?>
                      <li>
                        <a onclick="return confirm('Are you sure want to delete? If you do this all of your data will be lost.')" href="<?php echo e(route('setting.emptyDatabase')); ?>"><i class="dripicons-stack"></i> <?php echo e(ucfirst(trans('file.Empty Database'))); ?></a>
                      </li>
                      <?php endif; ?>
                      <li>
...
</html><?php /**PATH /home/u5070271/files-urekapos/resources/views/layout/main.blade.php ENDPATH**/ ?>