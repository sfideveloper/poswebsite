        ...
        <div class="row">
            <div class="col-md-12 text-right mb-4">
                <?php if(in_array("sales-add", $all_permission)): ?>
                    <a href="<?php echo e(route('sales.create')); ?>" class="btn btn-info p-3"><i class="dripicons-plus"></i> <?php echo e(trans('file.Add Sale')); ?></a>&nbsp;
                    <a href="<?php echo e(url('sales/sale_by_csv')); ?>" class="btn btn-primary p-3"><i class="dripicons-copy"></i> <?php echo e(trans('file.Import Sale')); ?></a>
                <?php endif; ?>
            </div>
            <div class="col-md-12">
                <div class="card">
                            ...
                            <table id="sale-table" class="table sale-list" style="width: 100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo e(ucfirst(trans('file.Sale Status'))); ?></th>
                                        <th><?php echo e(ucfirst(trans('file.Payment Status'))); ?></th>
    ...
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            <div class="container mt-3 pb-2 border-bottom">
                <div class="row">
                    <div class="col-md-3">
                        <button id="print-btn" type="button" class="btn btn-default btn-sm d-print-none"><i class="dripicons-print"></i> <?php echo e(ucfirst(trans('file.Print'))); ?></button>
                        
                        <?php echo e(Form::open(['route' => 'sale.sendmail', 'method' => 'post', 'class' => 'sendmail-form'] )); ?>

                            <input type="hidden" name="sale_id">
                            <button class="btn btn-default btn-sm d-print-none"><i class="dripicons-mail"></i> <?php echo e(ucfirst(trans('file.Email'))); ?></button>
                    ...
                    <div class="col-md-12 text-center">
                        <i style="font-size: 15px;"><?php echo e(ucfirst(trans('file.Sale Details'))); ?></i>
                    </div>
                </div>
            </div>
            ...
            <table class="table table-bordered product-sale-list">
                <thead>
                    ...
                    <th><?php echo e(ucfirst(trans('file.Discount'))); ?></th>
                    <th><?php echo e(ucfirst(trans('file.Subtotal'))); ?></th>
                </thead>
                <tbody>
                </tbody>
            </table>
    ...
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 id="exampleModalLabel" class="modal-title"><?php echo e(ucwords(trans('file.All'))); ?> <?php echo e(ucwords(trans('file.Payment'))); ?></h5>
...
<div id="add-payment" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 id="exampleModalLabel" class="modal-title"><?php echo e(ucwords(trans('file.Add Payment'))); ?></h5>
                <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
            </div>
            <div class="modal-body">
...
<div id="edit-payment" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 id="exampleModalLabel" class="modal-title"><?php echo e(ucwords(trans('file.Update Payment'))); ?></h5>
                <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
            </div>
            <div class="modal-body">
                <?php echo Form::open(['route' => 'sale.update-payment', 'method' => 'post', 'class' => 'payment-form' ]); ?>
                    ...
                    <div class="text-right">
                        <button type="submit" class="btn btn-primary btn-md-block"><?php echo e(ucfirst(trans('file.update'))); ?></button>
                    </div>
...
<div id="add-delivery" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 id="exampleModalLabel" class="modal-title"><?php echo e(ucwords(trans('file.Add Delivery'))); ?></h5>
                <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
            </div>
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-6 form-group">
                        <label><?php echo e(ucwords(trans('file.Delivery Reference'))); ?></label>
                        <p id="dr"></p>
                    </div>
                    <div class="col-md-6 form-group">
                        <label><?php echo e(ucwords(trans('file.Sale Reference'))); ?></label>
                        <p id="sr"></p>
                    </div>
                    <div class="col-md-12 form-group">
                        <label><?php echo e(ucwords(trans('file.Status'))); ?> *</label>
                    ...
                    <div class="col-md-6 mt-2 form-group">
                        <label><?php echo e(ucwords(trans('file.Delivered By'))); ?></label>
                    ...
                    <div class="col-md-6 form-group">
                        <label><?php echo e(ucwords(trans('file.Attach File'))); ?></label>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/pos.halalexportindonesia.com/project-files/resources/views/sale/index.blade.php ENDPATH**/ ?>