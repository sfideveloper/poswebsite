    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 text-right mb-4">
                <button class="btn btn-info p-3" data-toggle="modal" data-target="#createModal"><i class="dripicons-plus"></i> <?php echo e(ucfirst(trans('file.Add Count Stock'))); ?> </button>
            </div>
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Redesign Ureka\resources\views/stock_count/index.blade.php ENDPATH**/ ?>