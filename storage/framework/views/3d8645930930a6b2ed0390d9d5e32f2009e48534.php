    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4><?php echo e(ucwords(trans('file.Update User Profile'))); ?></h4>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label><?php echo e(ucwords(trans('file.UserName'))); ?> *</strong></label>
                                ...
                                <div class="form-group">
                                    <label><?php echo e(ucwords(trans('file.Email'))); ?> *</strong></label>
                                ...
                                <div class="form-group">
                                    <label><?php echo e(ucwords(trans('file.Phone Number'))); ?> *</strong></label>
                                    <input type="text" name="phone" value="<?php echo e($lims_user_data->phone); ?>" required class="form-control" />
                                </div>
                                <div class="form-group">
                                    <label><?php echo e(ucwords(trans('file.Company Name'))); ?></strong></label>
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4><?php echo e(ucwords(trans('file.Change Password'))); ?></h4>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label><?php echo e(ucwords(trans('file.Current Password'))); ?> *</strong></label>
                                    <input type="password" name="current_pass" required class="form-control" />
                                </div>
                                <div class="form-group">
                                    <label><?php echo e(ucwords(trans('file.New Password'))); ?> *</strong></label>
                                    <input type="password" name="new_pass" required class="form-control">
                                </div>
                                <div class="form-group">
                                    <label><?php echo e(ucwords(trans('file.Confirm Password'))); ?> *</strong></label>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/pos.halalexportindonesia.com/project-files/resources/views/user/profile.blade.php ENDPATH**/ ?>