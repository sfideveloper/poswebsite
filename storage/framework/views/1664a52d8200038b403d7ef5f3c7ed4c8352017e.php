        ...
        <div class="row">
            <div class="col-md-12 text-right mb-4">
                <?php if(in_array("users-add", $all_permission)): ?>
                    <a href="<?php echo e(route('user.create')); ?>" class="btn btn-info"><i class="dripicons-plus"></i> <?php echo e(ucfirst(trans('file.Add User'))); ?></a>
                <?php endif; ?>
            </div>
            <div class="col-md-12">
                <div class="card">
                            ...
                            <table id="user-table" class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo e(ucfirst(trans('file.UserName'))); ?></th>
                                        ...
                                        <th><?php echo e(ucfirst(trans('file.Role'))); ?></th>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                                    ...
                                                    <li>
                                                        <a href="<?php echo e(route('user.edit', $user->id)); ?>" class="btn btn-link"><i class="dripicons-document-edit"></i> <?php echo e(ucfirst(trans('file.edit'))); ?></a>
                                                    </li>
                                                    <?php endif; ?>
                                                    <li class="divider"></li>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/muqtadirulmajid/Development/Laravel/eksternal_project/poswebsite/resources/views/user/index.blade.php ENDPATH**/ ?>