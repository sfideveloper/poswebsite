...
<section>
    <div class="container-fluid">
        <button class="btn btn-info" data-toggle="modal" data-target="#createModal"><i class="dripicons-plus"></i> <?php echo e(ucfirst(trans('file.Add Attendance'))); ?> </button>
    </div>
        ...
        <table id="attendance-table" class="table">
            <thead>
                <tr>
                    ...
                    <th><?php echo e(ucfirst(trans('file.CheckIn'))); ?></th>
                    <th><?php echo e(ucfirst(trans('file.CheckOut'))); ?></th>
    ...
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 id="exampleModalLabel" class="modal-title"><?php echo e(ucwords(trans('file.Add Attendance'))); ?></h5>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Redesign Ureka\resources\views/attendance/index.blade.php ENDPATH**/ ?>