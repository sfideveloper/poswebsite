        ...
        <div class="row">
            <div class="col-md-12 text-right mb-4">
                <?php if(in_array("returns-add", $all_permission)): ?>
                    <a href="<?php echo e(route('return-sale.create')); ?>" class="btn btn-info p-3"><i class="dripicons-plus"></i> <?php echo e(trans('file.Add Return')); ?></a>
                <?php endif; ?>
            </div>
            <div class="col-md-12">
                <div class="card">
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                                    ...
                                                    <li>
                                                        <a href="<?php echo e(route('return-sale.edit', $return->id)); ?>" class="btn btn-link"><i class="dripicons-document-edit"></i> <?php echo e(ucfirst(trans('file.edit'))); ?></a>
                                                    </li>
                                                    <?php endif; ?>
                                                    <li class="divider"></li>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <button id="print-btn" type="button" class="btn btn-default btn-sm d-print-none"><i
                                class="dripicons-print"></i> <?php echo e(ucfirst(trans('file.Print'))); ?></button>
                        ...
                        <button class="btn btn-default btn-sm d-print-none"><i class="dripicons-mail"></i>
                            <?php echo e(ucfirst(trans('file.Email'))); ?></button>
                        <?php echo e(Form::close()); ?>
                    ...
                    <div class="col-md-12 text-center">
                        <i style="font-size: 15px;"><?php echo e(ucfirst(trans('file.Return Details'))); ?></i>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/pos.halalexportindonesia.com/project-files/resources/views/return/index.blade.php ENDPATH**/ ?>