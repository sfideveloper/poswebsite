        ...
        <div class="row">
            <div class="col-md-12 text-right mb-4">
                @if(in_array("quotes-add", $all_permission))
                    <a href="{{route('quotations.create')}}" class="btn btn-info p-3"><i class="dripicons-plus"></i> {{trans('file.Add Quotation')}}</a>
                @endif
            </div>
            <div class="col-md-12">
                <div class="card">
                            ...
                            <table id="quotation-table" class="table quotation-list">
                                <thead>
                                    <tr>
                                        ...
                                        <th>{{ucfirst(trans('file.Quotation Status'))}}</th>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                                    ...
                                                    <li>
                                                        <a class="btn btn-link" href="{{ route('quotations.edit', $quotation->id) }}"><i class="dripicons-document-edit"></i> {{ucfirst(trans('file.edit'))}}</a></button> 
                                                    </li>
                                                    @endif
                                                    <li>
                                                        <a class="btn btn-link" href="{{ route('quotation.create_sale', ['id' => $quotation->id]) }}"><i class="fa fa-shopping-cart"></i> {{ucfirst(trans('file.Create Sale'))}}</a></button> 
                                                    </li>
                                                    <li>
                                                        <a class="btn btn-link" href="{{ route('quotation.create_purchase', ['id' => $quotation->id]) }}"><i class="fa fa-shopping-basket"></i> {{ucfirst(trans('file.Create Purchase'))}}</a></button> 
                                                    </li>
                                                    <li class="divider"></li>
        ...
        <div class="container mt-3 pb-2 border-bottom">
            <div class="row">
                ...
                <div class="col-md-12 text-center">
                    <i style="font-size: 15px;">{{ucfirst(trans('file.Quotation Details'))}}</i>
                </div>
            </div>
        </div>
