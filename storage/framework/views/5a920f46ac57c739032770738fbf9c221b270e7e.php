                        ...
                        <?php echo Form::open(['route' => 'setting.sendSms', 'method' => 'post']); ?>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <button type="submit" class="btn btn-primary"><i class="fa fa-paper-plane"></i> <?php echo e(ucfirst(trans('file.Send SMS'))); ?></button> 
                                    </div>
                                </div>
                            </div>
                        <?php echo Form::close(); ?>
