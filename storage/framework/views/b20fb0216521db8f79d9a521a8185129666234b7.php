        ...
        <div class="container">
            <div class="form-outer d-flex align-items-center">
                <div class="form-inner py-5 px-4 px-sm-5">
                    ...
                    <p class="text-secondary">Silahkan masuk terlebih dahulu</p>
                    ...
                    <form method="POST" action="<?php echo e(route('login')); ?>" id="login-form">
                        ...
                        <div class="form-group-material">
                            ...
                            <?php endif; ?>
                           <a href="<?php echo e(route('password.request')); ?>" class="forgot-pass text-right mt-3"><?php echo e(trans('file.Forgot Password?')); ?></a>
...
<?php /**PATH /Users/muqtadirulmajid/Development/Laravel/eksternal_project/poswebsite/resources/views/auth/login.blade.php ENDPATH**/ ?>