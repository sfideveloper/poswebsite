    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 text-right mb-4">
                <button class="btn btn-info p-3" data-toggle="modal" data-target="#account-modal"><i class="dripicons-plus"></i> <?php echo e(ucfirst(trans('file.Add Account'))); ?></button>
            </div>
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <table id="account-table" class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th><?php echo e(ucfirst(trans('file.Account No'))); ?> </th>
                                    <th><?php echo e(ucfirst(trans('file.name'))); ?></th>
                                    <th><?php echo e(ucfirst(trans('file.Initial Balance'))); ?></th>
                                    <th><?php echo e(ucfirst(trans('file.Default'))); ?></th>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                                <li><button type="button" data-id="<?php echo e($account->id); ?>" data-account_no="<?php echo e($account->account_no); ?>" data-name="<?php echo e($account->name); ?>"  data-initial_balance="<?php echo e($account->initial_balance); ?>" data-note="<?php echo e($account->note); ?>" class="edit-btn btn btn-link" data-toggle="modal" data-target="#editModal"><i class="dripicons-document-edit"></i> <?php echo e(ucfirst(trans('file.edit'))); ?></button></li>
                                                <li class="divider"></li>
    ...
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 id="exampleModalLabel" class="modal-title"><?php echo e(ucwords(trans('file.Update Account'))); ?></h5>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/pos.halalexportindonesia.com/project-files/resources/views/account/index.blade.php ENDPATH**/ ?>