                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-12 mt-3">
                                        <label>{{ucwords(trans('file.Select Product'))}}</label>
                                ...
                                <div class="row mt-5">
                                    <div class="col-md-12">
                                        <h5>{{ucwords(trans('file.Order Table'))}} *</h5>
                                            ...
                                            <table id="myTable" class="table table-hover order-list">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>{{ucfirst(trans('file.Net Unit Price'))}}</th>
                                                        <th>{{ucfirst(trans('file.Discount'))}}</th>
                                                        <th>{{ucfirst(trans('file.Tax'))}}</th>
                                                        <th>{{ucfirst(trans('file.Subtotal'))}}</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <td><button type="button" class="ibtnDel btn btn-md btn-danger">{{ucfirst(trans("file.delete"))}}</button></td>
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <label>{{ucwords(trans('file.Order Tax'))}}</label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>
                                                <strong>{{ucwords(trans('file.Order Discount'))}}</strong>
                                            </label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>
                                                <strong>{{ucwords(trans('file.Shipping Cost'))}}</strong>
                                            </label>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>{{ucwords(trans('file.Attach Document'))}}</label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>{{ucwords(trans('file.Sale Status'))}} *</label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>{{ucwords(trans('file.Payment Status'))}} *</label>
                                ...
                                <div class="form-group text-right">
                                    <input type="submit" value="{{ucfirst(trans('file.submit'))}}" class="btn btn-primary btn-md-block" id="submit-button">
                                </div>
                            </div>
                        </div>
                        {!! Form::close() !!}
        ...
        <div class="card">
            <div class="card-body">
                <table class="table table-bordered table-condensed totals">
                    <td><strong>{{ucfirst(trans('file.Items'))}}</strong>
                        <span class="pull-right" id="item">0.00</span>
                    </td>
                    <td><strong>{{ucfirst(trans('file.Total'))}}</strong>
                        <span class="pull-right" id="subtotal">0.00</span>
                    </td>
                    <td><strong>{{ucfirst(trans('file.Order Tax'))}}</strong>
                        <span class="pull-right" id="order_tax">0.00</span>
                    </td>
                    <td><strong>{{ucfirst(trans('file.Order Discount'))}}</strong>
                        <span class="pull-right" id="order_discount">0.00</span>
                    </td>
                    <td><strong>{{ucfirst(trans('file.Shipping Cost'))}}</strong>
                        <span class="pull-right" id="shipping_cost">0.00</span>
                    </td>
                    <td><strong>{{ucfirst(trans('file.grand total'))}}</strong>
                    ...
                    <form>
                        ...
                        ?>
                            ...
                            <div class="text-right">
                                <button type="button" name="update_btn" class="btn btn-primary btn-md-block">{{trans('file.update')}}</button>
                            </div>
                    </form>
                </div>
            </div>
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if (flag) {
                ...
                cols += '<td><button type="button" class="ibtnDel btn btn-md btn-danger">{{ucfirst(trans("file.delete"))}}</button></td>';
