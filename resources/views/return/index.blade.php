        ...
        <div class="row">
            <div class="col-md-12 text-right mb-4">
                @if(in_array("returns-add", $all_permission))
                    <a href="{{route('return-sale.create')}}" class="btn btn-info p-3"><i class="dripicons-plus"></i> {{trans('file.Add Return')}}</a>
                @endif
            </div>
            <div class="col-md-12">
                <div class="card">
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                                    ...
                                                    <li>
                                                        <a href="{{ route('return-sale.edit', $return->id) }}" class="btn btn-link"><i class="dripicons-document-edit"></i> {{ucfirst(trans('file.edit'))}}</a>
                                                    </li>
                                                    @endif
                                                    <li class="divider"></li>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <button id="print-btn" type="button" class="btn btn-default btn-sm d-print-none"><i
                                class="dripicons-print"></i> {{ucfirst(trans('file.Print'))}}</button>
                        ...
                        <button class="btn btn-default btn-sm d-print-none"><i class="dripicons-mail"></i>
                            {{ucfirst(trans('file.Email'))}}</button>
                        {{ Form::close() }}
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-12 text-center">
                        <i style="font-size: 15px;">{{ucfirst(trans('file.Return Details'))}}</i>
                    </div>
                </div>
            </div>
