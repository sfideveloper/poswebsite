    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4>{{ucwords(trans('file.Update User Profile'))}}</h4>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>{{ucwords(trans('file.UserName'))}} *</strong></label>
                                ...
                                <div class="form-group">
                                    <label>{{ucwords(trans('file.Email'))}} *</strong></label>
                                ...
                                <div class="form-group">
                                    <label>{{ucwords(trans('file.Phone Number'))}} *</strong></label>
                                    <input type="text" name="phone" value="{{$lims_user_data->phone}}" required class="form-control" />
                                </div>
                                <div class="form-group">
                                    <label>{{ucwords(trans('file.Company Name'))}}</strong></label>
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4>{{ucwords(trans('file.Change Password'))}}</h4>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>{{ucwords(trans('file.Current Password'))}} *</strong></label>
                                    <input type="password" name="current_pass" required class="form-control" />
                                </div>
                                <div class="form-group">
                                    <label>{{ucwords(trans('file.New Password'))}} *</strong></label>
                                    <input type="password" name="new_pass" required class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>{{ucwords(trans('file.Confirm Password'))}} *</strong></label>
