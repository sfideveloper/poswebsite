            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4><?php echo e(ucwords(trans('file.Create SMS'))); ?></h4>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group twilio">
                                        <label><?php echo e(ucwords(trans('file.Mobile'))); ?> *</label>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group text-right">
                                        <button type="submit" class="btn btn-primary btn-md-block"><i class="fa fa-paper-plane"></i> <?php echo e(ucfirst(trans('file.Send SMS'))); ?></button> 
                                    </div>
                                </div>
                            </div>
                        <?php echo Form::close(); ?>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel project\posweb\resources\views/setting/create_sms.blade.php ENDPATH**/ ?>