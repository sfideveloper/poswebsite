        ...
        <div class="row">
            <div class="col-md-12 text-right mb-4">
                <?php if(in_array("quotes-add", $all_permission)): ?>
                    <a href="<?php echo e(route('quotations.create')); ?>" class="btn btn-info p-3"><i class="dripicons-plus"></i> <?php echo e(trans('file.Add Quotation')); ?></a>
                <?php endif; ?>
            </div>
            <div class="col-md-12">
                <div class="card">
                            ...
                            <table id="quotation-table" class="table quotation-list">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo e(ucfirst(trans('file.Quotation Status'))); ?></th>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                                    ...
                                                    <li>
                                                        <a class="btn btn-link" href="<?php echo e(route('quotations.edit', $quotation->id)); ?>"><i class="dripicons-document-edit"></i> <?php echo e(ucfirst(trans('file.edit'))); ?></a></button> 
                                                    </li>
                                                    <?php endif; ?>
                                                    <li>
                                                        <a class="btn btn-link" href="<?php echo e(route('quotation.create_sale', ['id' => $quotation->id])); ?>"><i class="fa fa-shopping-cart"></i> <?php echo e(ucfirst(trans('file.Create Sale'))); ?></a></button> 
                                                    </li>
                                                    <li>
                                                        <a class="btn btn-link" href="<?php echo e(route('quotation.create_purchase', ['id' => $quotation->id])); ?>"><i class="fa fa-shopping-basket"></i> <?php echo e(ucfirst(trans('file.Create Purchase'))); ?></a></button> 
                                                    </li>
                                                    <li class="divider"></li>
        ...
        <div class="container mt-3 pb-2 border-bottom">
            <div class="row">
                ...
                <div class="col-md-12 text-center">
                    <i style="font-size: 15px;"><?php echo e(ucfirst(trans('file.Quotation Details'))); ?></i>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/pos.halalexportindonesia.com/project-files/resources/views/quotation/index.blade.php ENDPATH**/ ?>