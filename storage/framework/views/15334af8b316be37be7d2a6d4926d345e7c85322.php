    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 mb-4">
                <h3><?php echo e(ucwords(trans('file.Balance Sheet'))); ?></h3>
            </div>
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                            ...
                            <table id="account-table" class="table table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo e(ucfirst(trans('file.Credit'))); ?></th>
                                        <th><?php echo e(ucfirst(trans('file.Debit'))); ?></th>
                                        <th>Balance</th>
                                    </tr>
                                </thead>
                                <tbody>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/pos.halalexportindonesia.com/project-files/resources/views/account/balance_sheet.blade.php ENDPATH**/ ?>