        ...
        <div class="row">
            <div class="col-md-12 text-right mb-4">
                @if(in_array("employees-add", $all_permission))
                    <a href="{{route('employees.create')}}" class="btn btn-info"><i class="dripicons-plus"></i> {{ucfirst(trans('file.Add Employee'))}}</a>
                @endif
            </div>
            <div class="col-md-12">
                <div class="card">
                        ...
                        <table id="employee-table" class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th>{{ucfirst(trans('file.Department'))}}</th>
    ...
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 id="exampleModalLabel" class="modal-title">{{ucwords(trans('file.Update Employee'))}}</h5>
            ...
            <div class="modal-body">
              <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 form-group">
                        <label>{{ucwords(trans('file.Department'))}} *</label>
                    ...
                    <div class="col-md-6 form-group">
                        <label>{{ucwords(trans('file.Country'))}}</label>
