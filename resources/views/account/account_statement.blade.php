    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 mb-4">
                <h3>{{ucwords(trans('file.Account Statement'))}}</h3>
                <strong>{{ucwords(trans('file.Account'))}}:</strong> {{$lims_account_data->name}} [{{$lims_account_data->account_no}}]
            </div>
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                            ...
                            <table id="account-table" class="table table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th>{{ucfirst(trans('file.Credit'))}}</th>
                                        <th>{{ucfirst(trans('file.Debit'))}}</th>
