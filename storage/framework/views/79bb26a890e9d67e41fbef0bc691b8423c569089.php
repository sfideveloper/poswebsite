                        ...
                        <div class="row">
                            <div class="col-md-12">
                                            ...
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <td><button type="button" class="ibtnDel btn btn-md btn-danger"><?php echo e(ucfirst(trans("file.delete"))); ?></button></td>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label><?php echo e(ucwords(trans('file.Attach Document'))); ?></label>
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if (flag) {
                ...
                cols += '<td><button type="button" class="ibtnDel btn btn-md btn-danger"><?php echo e(ucfirst(trans("file.delete"))); ?></button></td>';
