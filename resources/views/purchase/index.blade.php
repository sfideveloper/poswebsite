        ...
        <div class="row">
            <div class="col-md-12 text-right mb-4">
                @if(in_array("purchases-add", $all_permission))
                    <a href="{{route('purchases.create')}}" class="btn btn-info p-3"><i class="dripicons-plus"></i> {{ucfirst(trans('file.Add Purchase'))}}</a>&nbsp;
                    <a href="{{url('purchases/purchase_by_csv')}}" class="btn btn-primary p-3"><i class="dripicons-copy"></i> {{ucfirst(trans('file.Import Purchase'))}}</a>
                @endif
            </div>
            <div class="col-md-12">
                <div class="card">
                            ...
                            <table id="purchase-table" class="table purchase-list" style="width: 100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th>{{ucfirst(trans('file.Purchase Status'))}}</th>
        ...
        <div class="container mt-3 pb-2 border-bottom">
            <div class="row">
                ...
                <div class="col-md-12 text-center">
                    <i style="font-size: 15px;">{{ucfirst(trans('file.Purchase Details'))}}</i>
                </div>
            </div>
        </div>
            ...
            <table class="table table-bordered product-purchase-list">
                <thead>
                    ...
                    <th>Qty</th>
                    <th>{{ucfirst(trans('file.Unit Cost'))}}</th>
    ...
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 id="exampleModalLabel" class="modal-title">{{ucwords(trans('file.All Payment'))}}</h5>
                ...
                <table class="table table-hover payment-list">
                    <thead>
                        <tr>
                            ...
                            <th>{{ucfirst(trans('file.Account'))}}</th>
            ...
            <div class="modal-body">
                {!! Form::open(['route' => 'purchase.add-payment', 'method' => 'post', 'class' => 'payment-form' ]) !!}
                    <div class="row">
                        ...
                        <div class="col-md-6 mt-1">
                            <label>{{ucwords(ucwords(trans('file.Paid By')))}}</label>
