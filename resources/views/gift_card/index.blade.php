    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 text-right mb-4">
                <button class="btn btn-info p-3" data-toggle="modal" data-target="#gift_card-modal"><i class="dripicons-plus"></i> {{ucfirst(trans('file.Add Gift Card'))}}</button>
            </div>
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                            ...
                            <table id="gift_card-table" class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th>{{ucfirst(trans('file.Card No'))}}</th>
                                        <th>{{ucfirst(trans('file.customer'))}}</th>
                                        <th>{{ucfirst(trans('file.Amount'))}}</th>
                                        <th>{{ucfirst(trans('file.Expense'))}}</th>
                                        <th>Balance</th>
                                        <th>{{ucfirst(trans('file.Created By'))}}</th>
                                        <th>{{ucfirst(trans('file.Expired Date'))}}</th>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                                    <li><button type="button" data-client="{{$client}}" data-card_no="{{$gift_card->card_no}}" data-amount="{{$gift_card->amount}}" data-expense="{{$gift_card->expense}}" data-expired_date="{{date('d-m-Y', strtotime($gift_card->expired_date))}}" class="view-btn btn btn-link" data-toggle="modal" data-target="#viewModal"><i class="fa fa-eye"></i> {{ucfirst(trans('file.View'))}}</button></li>
                                                    <li><button type="button" data-id="{{$gift_card->id}}" class="open-Edit_gift_card_Dialog btn btn-link" data-toggle="modal" data-target="#editModal"><i class="dripicons-document-edit"></i> {{ucfirst(trans('file.edit'))}}</button></li>
                                                    <li><button type="button" data-id="{{$gift_card->id}}" class="recharge btn btn-link" data-toggle="modal" data-target="#rechargeModal"><i class="fa fa-money"></i> {{ucfirst(trans('file.Recharge'))}}</button></li>
                                                    <li class="divider"></li>
  ...
  <div role="document" class="modal-dialog">
      <div class="modal-content">
          <div class="modal-header">
              <h5 id="exampleModalLabel" class="modal-title d-print-none"> {{ucwords(trans('file.Card Details'))}} &nbsp;&nbsp;</h5>
...
<div id="gift_card-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 id="exampleModalLabel" class="modal-title">{{ucwords(trans('file.Add Gift Card'))}}</h5>
              ...
              <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
                ...
                ?>
                  <div class="form-group">
                      <label>{{ucwords(trans('file.Card No'))}} *</label>
                  ...
                  <div class="form-group">
                      <label>{{ucwords(trans('file.User List'))}}</label>&nbsp;
                  ...
                  <div class="form-group">
                      <label>{{ucwords(trans('file.Expired Date'))}}</label>
...
<div id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
  <div role="document" class="modal-dialog">
      <div class="modal-content">
          <div class="modal-header">
              <h5 id="exampleModalLabel" class="modal-title">{{ucwords(trans('file.Update Gift Card'))}}</h5>
              <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
          </div>
          <div class="modal-body">
            <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
...
<div id="rechargeModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
  <div role="document" class="modal-dialog">
      <div class="modal-content">
          <div class="modal-header">
              <h5 id="exampleModalLabel" class="modal-title"> {{ucwords(trans('file.Card No'))}}: <span id="card-no"></span></h5>
              <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
          </div>
          <div class="modal-body">
            <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
