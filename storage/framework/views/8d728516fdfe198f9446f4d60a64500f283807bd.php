    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 text-right mb-4">
                <a href="#" data-toggle="modal" data-target="#createModal" class="btn btn-info btn-md-block"><i class="dripicons-plus"></i> <?php echo e(ucfirst(trans('file.Add Role'))); ?> </a>
            </div>
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                            ...
                            <table id="role-table" class="table table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo e(ucfirst(trans('file.Description'))); ?></th>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                                    <li>
                                                        <button type="button" data-id="<?php echo e($role->id); ?>" class="open-EditroleDialog btn btn-link" data-toggle="modal" data-target="#editModal"><i class="dripicons-document-edit"></i> <?php echo e(ucfirst(trans('file.edit'))); ?>

                                                    </button>
                                                    </li>
                                                    <li class="divider"></li>
                                                    <li>
                                                        <a href="<?php echo e(route('role.permission', ['id' => $role->id])); ?>" class="btn btn-link"><i class="dripicons-lock-open"></i> <?php echo e(ucfirst(trans('file.Change Permission'))); ?></a>
                                                    </li>
    ...
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 id="exampleModalLabel" class="modal-title"><?php echo e(ucwords(trans('file.Add Role'))); ?></h5>
            ...
            <div class="modal-body">
                ...
                <form>
                    ...
                    <div class="form-group">
                        <label><?php echo e(ucwords(trans('file.Description'))); ?></label>
...
<div id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
	<div role="document" class="modal-dialog">
		  <div class="modal-content">
		    ...
		    <div class="modal-header">
		      <h5 id="exampleModalLabel" class="modal-title"><?php echo e(ucwords(trans('file.Update Role'))); ?></h5>
		      <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
		    </div>
		    <div class="modal-body">
		      <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/muqtadirulmajid/Development/Laravel/eksternal_project/poswebsite/resources/views/role/create.blade.php ENDPATH**/ ?>