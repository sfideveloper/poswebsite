    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="payment-amount">
                        <h2><?php echo e(ucwords(trans('file.grand total'))); ?> <?php echo e($currency->code); ?> <span id="grand-total">0.00</span></h2>
                    </div>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-10">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mt-1">
                                            ...
                                            <select name="paid_by_id_select" class="form-control selectpicker">
                                                ...
                                                <option value="2">Gift Card/Voucher</option>
                                    ...
                                    <div class="mt-3">
                                        <button id="submit-btn" type="button" class="btn btn-primary"><?php echo e(ucfirst(trans('file.submit'))); ?></button>
                                    </div>
                                </div>
                ...
                <div role="document" class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <button type="button" name="order_discount_btn" class="btn btn-primary" data-dismiss="modal"><?php echo e(ucfirst(trans('file.submit'))); ?></button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div role="document" class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <button type="button" class="btn btn-primary coupon-check" data-dismiss="modal"><?php echo e(ucfirst(trans('file.submit'))); ?></button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div role="document" class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <button type="button" name="order_tax_btn" class="btn btn-primary" data-dismiss="modal"><?php echo e(ucfirst(trans('file.submit'))); ?></button>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div role="document" class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <button type="button" name="shipping_cost_btn" class="btn btn-primary" data-dismiss="modal"><?php echo e(ucfirst(trans('file.submit'))); ?></button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
    			...
    			<div class="row">
                    <div class="col-md-4">
                        <button class="btn btn-block btn-primary" id="category-filter"><?php echo e(ucfirst(trans('file.category'))); ?></button>
                    </div>
                    <div class="col-md-4">
                        <button class="btn btn-block btn-info" id="brand-filter"><?php echo e(ucfirst(trans('file.Brand'))); ?></button>
                    </div>
                    <div class="col-md-4">
                        <button class="btn btn-block btn-danger" id="featured-filter"><?php echo e(ucfirst(trans('file.Featured'))); ?></button>
                    </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form>
                                ...
                                <button type="button" name="update_btn" class="btn btn-primary"><?php echo e(ucfirst(trans('file.update'))); ?></button>
                            </form>
                        </div>
                    </div>
                </div>
            ...
            <div id="recentTransaction" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
                <div role="document" class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 id="exampleModalLabel" class="modal-title"><?php echo e(ucwords(trans('file.Recent Transaction'))); ?> <div class="badge badge-primary"><?php echo e(ucwords(trans('file.latest'))); ?> 10</div></h5>
                      <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
                    </div>
                    <div class="modal-body">
                      ...
                      <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
                        <div class="row">
                          ...
                          <div class="col-md-12 form-group">
                              <button type="submit" class="btn btn-primary"><?php echo e(ucfirst(trans('file.submit'))); ?></button>
                          </div>
                        </div>
                    </div>
                    <?php echo e(Form::close()); ?>
...
<?php echo $__env->make('layout.top-head', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u5070271/files-urekapos/resources/views/sale/pos.blade.php ENDPATH**/ ?>