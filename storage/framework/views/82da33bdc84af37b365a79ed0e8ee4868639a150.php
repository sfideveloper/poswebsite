                            ...
                            <table id="delivery-table" class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo e(ucfirst(trans('file.Delivery Reference'))); ?></th>
                                        <th><?php echo e(ucfirst(trans('file.Sale Reference'))); ?></th>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                                    <li>
                                                        <button type="button" data-id="<?php echo e($delivery->id); ?>" class="open-EditCategoryDialog btn btn-link"><i class="dripicons-document-edit"></i> <?php echo e(ucfirst(trans('file.edit'))); ?></button>
                                                    </li>
                                                    <li class="divider"></li>
        ...
        <div class="container mt-3 pb-2 border-bottom">
            <div class="row">
                ...
                <div class="col-md-12 text-center">
                    <i style="font-size: 15px;"><?php echo e(ucwords(trans('file.Delivery Details'))); ?></i>
                </div>
            </div>
        </div>
    ...
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 id="exampleModalLabel" class="modal-title"><?php echo e(ucwords(trans('file.Update Delivery'))); ?></h5>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mt-2 form-group">
                        <label><?php echo e(ucwords(trans('file.Recieved By'))); ?></label>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/pos.halalexportindonesia.com/project-files/resources/views/delivery/index.blade.php ENDPATH**/ ?>