            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4><?php echo e(ucwords(trans('file.Update User'))); ?></h4>
                    </div>
                    <div class="card-body">
                        ...
                        <?php echo Form::open(['route' => ['user.update', $lims_user_data->id], 'method' => 'put', 'files' => true]); ?>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label><strong><?php echo e(ucwords(trans('file.Change Password'))); ?></strong></label>
                                    ...
                                    <div class="form-group text-right">
                                        <input type="submit" value="<?php echo e(ucwords(trans('file.submit'))); ?>" class="btn btn-primary btn-md-block">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/muqtadirulmajid/Development/Laravel/eksternal_project/poswebsite/resources/views/user/edit.blade.php ENDPATH**/ ?>