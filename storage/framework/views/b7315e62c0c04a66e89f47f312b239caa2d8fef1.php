    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header mt-2">
                <h3 class="text-center"><?php echo e(ucwords(trans('file.User Report'))); ?></h3>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-4 mt-3">
                    <div class="form-group row">
                        <label class="d-tc mt-2"><strong><?php echo e(ucwords(trans('file.Choose User'))); ?></strong> &nbsp;</label>
                        <div class="d-tc">
                ...
                <table id="purchase-table" class="table table-hover">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo e(ucfirst(trans('file.product'))); ?> (<?php echo e(ucfirst(trans('file.qty'))); ?>)</th>
                            <th><?php echo e(ucfirst(trans('file.grand total'))); ?></th>
                            <th><?php echo e(ucfirst(trans('file.Paid Amount'))); ?></th>
                            <th><?php echo e(ucfirst(trans('file.Due'))); ?></th>
                            <th><?php echo e(ucfirst(trans('file.Status'))); ?></th>
                        </tr>
                    </thead>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Laravel project\poswebsite\resources\views/report/user_report.blade.php ENDPATH**/ ?>