            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4>{{ucwords(trans('file.Update Purchase'))}}</h4>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>{{ucwords(trans('file.Reference No'))}}</label>
                                ...
                                <div class="row">
                                	<div class="col-md-4">
                                        <div class="form-group">
                                            <label>{{ucwords(trans('file.Purchase Status'))}}</label>
                                            ...
                                            <table id="myTable" class="table table-hover order-list">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="recieved-product-qty d-none">{{ucfirst(trans('file.Recieved'))}}</th>
                                                        <th>{{ucfirst(trans('file.Net Unit Cost'))}}</th>
                                ...
                                <div class="row mt-5">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>
                                                <strong>{{ucwords(trans('file.Discount'))}}</strong>
                                            </label>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="form-group">
                            <label>{{ucwords(trans('file.Unit Cost'))}}</label>
