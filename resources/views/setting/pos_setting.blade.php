            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4>{{ucwords(trans('file.POS Setting'))}}</h4>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>{{ucwords(trans('file.Default Customer'))}} *</label>
                                    ...
                                    <div class="form-group">
                                        <label>{{ucwords(trans('file.Default Biller'))}} *</label>
                                        @if($lims_pos_setting_data)
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>{{ucwords(trans('file.Default Warehouse'))}} *</label>
                                        @if($lims_pos_setting_data)
                                    ...
                                    <div class="form-group">
                                        <label>{{ucwords(trans('file.Displayed Number of Product Row'))}} *</label>
