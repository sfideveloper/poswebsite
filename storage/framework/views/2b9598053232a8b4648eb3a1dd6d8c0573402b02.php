            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4><?php echo e(ucwords(trans('file.print_barcode'))); ?></h4>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group mt-2">
                                    <strong><?php echo e(ucfirst(trans('file.Print'))); ?>: </strong>&nbsp;
                                    <strong><input type="checkbox" name="name" checked /> <?php echo e(ucfirst(trans('file.Product Name'))); ?></strong>&nbsp;
                                    <strong><input type="checkbox" name="price" checked/> <?php echo e(ucfirst(trans('file.Price'))); ?></strong>&nbsp;
                                    <strong><input type="checkbox" name="promo_price"/> <?php echo e(ucfirst(trans('file.Promotional Price'))); ?></strong>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                ...
                                <div class="form-group mt-3 text-right">
                                    <input type="submit" value="<?php echo e(ucfirst(trans('file.submit'))); ?>" class="btn btn-primary p-3 btn-md-block" id="submit-button">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div role="document" class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                  <h5 id="modal_header" class="modal-title"><?php echo e(ucfirst(trans('file.Barcode'))); ?></h5>&nbsp;&nbsp;
                  <button id="print-btn" type="button" class="btn btn-default btn-sm"><i class="dripicons-print"></i> <?php echo e(ucfirst(trans('file.Print'))); ?></button>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/pos.halalexportindonesia.com/project-files/resources/views/product/print_barcode.blade.php ENDPATH**/ ?>