...
<section>
    <div class="container-fluid">
        <?php if(in_array("purchases-add", $all_permission)): ?>
            <a href="<?php echo e(route('purchases.create')); ?>" class="btn btn-info"><i class="dripicons-plus"></i> <?php echo e(ucfirst(trans('file.Add Purchase'))); ?></a>&nbsp;
            <a href="<?php echo e(url('purchases/purchase_by_csv')); ?>" class="btn btn-primary"><i class="dripicons-copy"></i> <?php echo e(ucfirst(trans('file.Import Purchase'))); ?></a>
        <?php endif; ?>
    </div>
        ...
        <table id="purchase-table" class="table purchase-list" style="width: 100%">
            <thead>
                <tr>
                    ...
                    <th><?php echo e(ucfirst(trans('file.Purchase Status'))); ?></th>
        ...
        <div class="container mt-3 pb-2 border-bottom">
            <div class="row">
                ...
                <div class="col-md-12 text-center">
                    <i style="font-size: 15px;"><?php echo e(ucfirst(trans('file.Purchase Details'))); ?></i>
                </div>
            </div>
        </div>
            ...
            <table class="table table-bordered product-purchase-list">
                <thead>
                    ...
                    <th>Qty</th>
                    <th><?php echo e(ucfirst(trans('file.Unit Cost'))); ?></th>
    ...
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 id="exampleModalLabel" class="modal-title"><?php echo e(ucwords(trans('file.All Payment'))); ?></h5>
                ...
                <table class="table table-hover payment-list">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo e(ucfirst(trans('file.Account'))); ?></th>
            ...
            <div class="modal-body">
                <?php echo Form::open(['route' => 'purchase.add-payment', 'method' => 'post', 'class' => 'payment-form' ]); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mt-1">
                            <label><?php echo e(ucwords(ucwords(trans('file.Paid By')))); ?></label>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u5070271/files-urekapos/resources/views/purchase/index.blade.php ENDPATH**/ ?>