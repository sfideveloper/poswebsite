    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 text-right mb-4">
                <button class="btn btn-info p-3" data-toggle="modal" data-target="#create-modal"><i class="dripicons-plus"></i> <?php echo e(ucfirst(trans('file.Add Coupon'))); ?></button>
            </div>
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                            ...
                            <table id="coupon-table" class="table" style="width:100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo e(ucfirst(trans('file.Coupon Code'))); ?></th>
                                        <th><?php echo e(ucfirst(trans('file.Type'))); ?></th>
                                        <th><?php echo e(ucfirst(trans('file.Amount'))); ?></th>
                                        <th><?php echo e(ucfirst(trans('file.Minimum Amount'))); ?></th>
                                        <th>Qty</th>
                                        <th><?php echo e(ucfirst(trans('file.Available'))); ?></th>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                                    <li><button type="button" data-id="<?php echo e($coupon->id); ?>" data-code="<?php echo e($coupon->code); ?>" data-type="<?php echo e($coupon->type); ?>" data-amount="<?php echo e($coupon->amount); ?>" data-minimum_amount="<?php echo e($coupon->minimum_amount); ?>" data-quantity="<?php echo e($coupon->quantity); ?>" data-expired_date="<?php echo e($coupon->expired_date); ?>" class="edit-btn btn btn-link" data-toggle="modal" data-target="#editModal"><i class="dripicons-document-edit"></i> <?php echo e(ucfirst(trans('file.edit'))); ?></button></li>
              ...
              <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
                <?php echo Form::open(['route' => 'coupons.store', 'method' => 'post']); ?>
                  ...
                  <div class="form-group text-right">
                      <button type="submit" class="btn btn-primary btn-md-block"><?php echo e(trans('file.submit')); ?></button>
                  </div>
                <?php echo e(Form::close()); ?>
...
<div id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
  <div role="document" class="modal-dialog">
      <div class="modal-content">
          <div class="modal-header">
              <h5 id="exampleModalLabel" class="modal-title"><?php echo e(ucwords(trans('file.Update Coupon'))); ?></h5>
              <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
          </div>
          <div class="modal-body">
            <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
              ...
              <div class="row">
                <div class="col-md-6 form-group">
                    <label><?php echo e(ucwords(trans('file.Coupon'))); ?> <?php echo e(ucwords(trans('file.Code'))); ?> *</label>
                    <div class="input-group">
                        <input type="hidden" name="coupon_id">
                        <?php echo e(Form::text('code',null,array('required' => 'required', 'class' => 'form-control'))); ?>

                        <div class="input-group-append">
                            <button type="button" class="btn btn-default btn-sm genbutton"><?php echo e(ucwords(trans('file.Generate'))); ?></button>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 form-group">
                ...
                <div class="col-md-6 form-group minimum-amount">
                    <label><?php echo e(ucwords(trans('file.Minimum Amount'))); ?> *</label>
                    <input type="number" name="minimum_amount" step="any" class="form-control">
                </div>
                <div class="col-md-6 form-group">
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/pos.halalexportindonesia.com/project-files/resources/views/coupon/index.blade.php ENDPATH**/ ?>