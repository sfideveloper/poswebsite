            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4><?php echo e(ucwords(trans('file.Mail Setting'))); ?></h4>
                    </div>
                    <div class="card-body">
                        ...
                        <?php echo Form::open(['route' => 'setting.mailStore', 'files' => true, 'method' => 'post']); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <label><?php echo e(ucwords(trans('file.Encryption'))); ?> *</label>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/pos.halalexportindonesia.com/project-files/resources/views/setting/mail_setting.blade.php ENDPATH**/ ?>