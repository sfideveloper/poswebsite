                        ...
                        <div class="row">
                            <div class="col-md-12">
		                        ...
		                        <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label><?php echo e(ucwords(trans('file.Order Discount'))); ?></label>
                                            <input type="number" name="order_discount" class="form-control" step="any">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label><?php echo e(ucwords(trans('file.Shipping Cost'))); ?></label>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/pos.halalexportindonesia.com/project-files/resources/views/quotation/create.blade.php ENDPATH**/ ?>