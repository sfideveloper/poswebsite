            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4><?php echo e(ucwords(trans('file.Update Sale'))); ?></h4>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label><?php echo e(ucwords(trans('file.reference'))); ?></label>
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-12">
                                        <label><?php echo e(ucwords(trans('file.Select Product'))); ?></label>
                                ...
                                <div class="row mt-5">
                                    <div class="col-md-12">
                                        <h5><?php echo e(ucwords(trans('file.Order Table'))); ?> *</h5>
                                            ...
                                            <table id="myTable" class="table table-hover order-list">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th><?php echo e(ucfirst(trans('file.Net Unit Price'))); ?></th>
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <label><?php echo e(ucwords(trans('file.Order Tax'))); ?></label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>
                                                <strong><?php echo e(ucwords(trans('file.Order Discount'))); ?></strong>
                                            </label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>
                                                <strong><?php echo e(ucwords(trans('file.Shipping Cost'))); ?></strong>
                                            </label>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label><?php echo e(ucwords(trans('file.Attach Document'))); ?></label> <i class="dripicons-question" data-toggle="tooltip" title="Only jpg, jpeg, png, gif, pdf, csv, docx, xlsx and txt file is supported"></i> 
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label><?php echo e(ucwords(trans('file.Sale Status'))); ?> *</label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>
                                                <strong><?php echo e(ucwords(trans('file.Coupon Discount'))); ?></strong>
                                            </label>
                                ...
                                <div class="form-group">
                                    <input type="submit" value="<?php echo e(ucfirst(trans('file.submit'))); ?>" class="btn btn-primary" id="submit-button">
                                </div>
                            </div>
                        </div>
                        <?php echo Form::close(); ?>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u5070271/files-urekapos/resources/views/sale/edit.blade.php ENDPATH**/ ?>