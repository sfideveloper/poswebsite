    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 text-right">
                ...
                <button type="button" class="btn btn-info p-3 mb-3" data-toggle="modal" data-target="#createModal"><i class="dripicons-plus"></i> {{ucfirst(trans("file.Add Category"))}}</button>&nbsp;
                <button class="btn btn-primary p-3 mb-3" data-toggle="modal" data-target="#importCategory"><i class="dripicons-copy"></i> {{ucfirst(trans('file.Import Category'))}}</button>
            </div>
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                            ...
                            <table id="category-table" class="table" style="width: 100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th>{{ucfirst(trans('file.Parent Category'))}}</th>
                                        <th>{{ucfirst(trans('file.Number of Product'))}}</th>
                                        <th>{{ucfirst(trans('file.Stock Quantity'))}}</th>
                                        <th>{{ucfirst(trans('file.Stock Worth (Price/Cost)'))}}</th>
    ...
    <div role="document" class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h5 id="exampleModalLabel" class="modal-title">{{ucwords(trans('file.Add Category'))}}</h5>
        ...
        <div class="modal-body">
          <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
            <div class="row">
                ...
                <div class="col-md-6 form-group">
                    <label>{{ucwords(trans('file.Image'))}}</label>
                    <input type="file" name="image" class="form-control">
                </div>
                <div class="col-md-6 form-group">
                    <label>{{ucwords(trans('file.Parent Category'))}}</label>
...
<div id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
  <div role="document" class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h5 id="exampleModalLabel" class="modal-title">{{ucwords(trans('file.Update Category'))}}</h5>
        <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
      </div>
      <div class="modal-body">
        <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
...
<div id="importCategory" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h5 id="exampleModalLabel" class="modal-title">{{ucwords(trans('file.Import Category'))}}</h5>
          <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
        </div>
        <div class="modal-body">
            <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
