        ...
        <div class="row">
            <div class="col-md-12 text-right mb-4">
                @if(in_array("purchase-return-add", $all_permission))
                    <a href="{{route('return-purchase.create')}}" class="btn btn-info p-3"><i class="dripicons-plus"></i> {{trans('file.Add Return')}}</a>
                @endif
            </div>
            <div class="col-md-12">
                <div class="card">
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                                    ...
                                                    <li>
                                                        <a href="{{ route('return-purchase.edit', $return->id) }}" class="btn btn-link"><i class="dripicons-document-edit"></i> {{ucfirst(trans('file.edit'))}}</a>
                                                    </li>
                                                    @endif
                                                    <li class="divider"></li>
