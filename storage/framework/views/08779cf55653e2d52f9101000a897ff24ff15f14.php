                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group text-right">
                                        <input type="button" value="<?php echo e(ucfirst(trans('file.submit'))); ?>" class="btn btn-primary btn-md-block" id="submit-btn">
                                    </div>
                                </div>
                            </div>
                        </form>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u5070271/newureka/resources/views/product/edit.blade.php ENDPATH**/ ?>