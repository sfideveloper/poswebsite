            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4><?php echo e(ucwords(trans('file.Update Purchase'))); ?></h4>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label><?php echo e(ucwords(trans('file.Reference No'))); ?></label>
                                ...
                                <div class="row">
                                	<div class="col-md-4">
                                        <div class="form-group">
                                            <label><?php echo e(ucwords(trans('file.Purchase Status'))); ?></label>
                                            ...
                                            <table id="myTable" class="table table-hover order-list">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="recieved-product-qty d-none"><?php echo e(ucfirst(trans('file.Recieved'))); ?></th>
                                                        <th><?php echo e(ucfirst(trans('file.Net Unit Cost'))); ?></th>
                                ...
                                <div class="row mt-5">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>
                                                <strong><?php echo e(ucwords(trans('file.Discount'))); ?></strong>
                                            </label>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="form-group">
                            <label><?php echo e(ucwords(trans('file.Unit Cost'))); ?></label>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u5070271/files-urekapos/resources/views/purchase/edit.blade.php ENDPATH**/ ?>