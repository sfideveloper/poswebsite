    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 text-right mb-4">
                <button class="btn btn-info p-3" data-toggle="modal" data-target="#createModal"><i class="dripicons-plus"></i> {{ucfirst(trans('file.Count Stock'))}} </button>
            </div>
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                            ...
                            <table id="stock-count-table" class="table stock-count-list">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="not-exported">{{ucfirst(trans('file.Initial File'))}}</th>
                                        <th class="not-exported">{{ucfirst(trans('file.Final File'))}}</th>
    ...
    <div role="document" class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h5 id="exampleModalLabel" class="modal-title">{{ucwords(trans('file.Count Stock'))}}</h5>
          ...
          <p class="italic"><small>{{trans('file.The field labels marked with * are required input fields')}}.</small></p>
            <div class="row">
                ...
                <div class="col-md-6 form-group" id="category">
                    <label>{{ucwords(trans('file.category'))}}</label>
                ...
                <div class="col-md-6 form-group" id="brand">
                    <label>{{ucwords(trans('file.Brand'))}}</label>
...
<div id="finalizeModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
  <div role="document" class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h5 id="exampleModalLabel" class="modal-title">{{ucwords(trans('file.Finalize Stock Count'))}}</h5>
        <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
      </div>
        <div class="modal-body">
            ...
            <div class="form-group">
                <label>{{ucwords(trans('file.Upload File'))}} *</label>
            ...
            <div class="container mt-3 pb-3">
                ...
                <table class="table table-bordered stockdif-list">
                    <thead>
                        ...
                        <th>{{ucfirst(trans('file.Expected'))}}</th>
                        <th>{{ucfirst(trans('file.Counted'))}}</th>
                        <th>{{ucfirst(trans('file.Difference'))}}</th>
                        <th>{{ucfirst(trans('file.Cost'))}}</th>
                    </thead>
                    <tbody>
                    </tbody>
                </table>
