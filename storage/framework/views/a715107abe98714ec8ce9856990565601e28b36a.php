        ...
        <div class="row">
            <div class="col-md-12 text-right">
                <?php if(in_array("products-add", $all_permission)): ?>
                    <a href="<?php echo e(route('products.create')); ?>" class="btn btn-info p-3 mb-3"><i class="dripicons-plus"></i> <?php echo e(ucfirst(__('file.add_product'))); ?></a>
                    <a href="#" data-toggle="modal" data-target="#importProduct" class="btn btn-primary p-3 mb-3"><i class="dripicons-copy"></i> <?php echo e(ucfirst(__('file.import_product'))); ?></a>
                <?php endif; ?>
            </div>
            <div class="col-md-12">
                <div class="card">
        ...
        <div class="modal-body">
          <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
           ...
           <div class="row">
            ...
            <?php echo e(Form::submit('Submit', ['class' => 'btn btn-primary btn-md-block'])); ?>
...
<div id="product-details" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 id="exampleModalLabel" class="modal-title"><?php echo e(ucwords(trans('Product Details'))); ?></h5>
        ...
        if(product[0] == 'combo') {
            ...
            $.get('products/product_warehouse/' + product[12], function(data) {
                ...
                if(data.product_variant_warehouse[0].length != 0) {
                    ...
                    var newBody = $("<tbody>");
                    var newRow = $("<tr>");
                    newRow.append('<th><?php echo e(ucfirst(trans("file.Warehouse"))); ?></th><th><?php echo e(ucfirst(trans("file.Variant"))); ?></th><th><?php echo e(ucfirst(trans("file.Quantity"))); ?></th>');
                    newHead.append(newRow);
                    $.each(warehouse, function(index){
                        var newRow = $("<tr>");
                        var cols = '';
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/pos.halalexportindonesia.com/project-files/resources/views/product/index.blade.php ENDPATH**/ ?>