        ...
        <div class="row">
            <div class="col-md-12 text-right mb-4">
                <?php if(in_array("transfers-add", $all_permission)): ?>
                    <a href="<?php echo e(route('transfers.create')); ?>" class="btn btn-info p-3"><i class="dripicons-plus"></i> <?php echo e(ucfirst(trans('file.add'))); ?> <?php echo e(ucfirst(trans('file.Transfer'))); ?></a>
                    <a href="<?php echo e(url('transfers/transfer_by_csv')); ?>" class="btn btn-primary p-3"><i class="dripicons-copy"></i> <?php echo e(ucfirst(trans('file.import'))); ?> <?php echo e(ucfirst(trans('file.Transfer'))); ?></a>
                <?php endif; ?>
            </div>
            <div class="col-md-12">
                <div class="card">
                            ...
                            <table id="transfer-table" class="table transfer-list">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo e(ucfirst(trans('file.Warehouse'))); ?>(<?php echo e(ucfirst(trans('file.From'))); ?>)</th>
                                        <th><?php echo e(ucfirst(trans('file.Warehouse'))); ?>(<?php echo e(ucfirst(trans('file.To'))); ?>)</th>
                                        <th><?php echo e(ucfirst(trans('file.product'))); ?> <?php echo e(ucfirst(trans('file.Cost'))); ?></th>
                                        <th><?php echo e(ucfirst(trans('file.product'))); ?> <?php echo e(ucfirst(trans('file.Tax'))); ?></th>
                                ...
                                <tbody>
                                    ...
                                    <tr class="transfer-link" data-transfer='["<?php echo e(date($general_setting->date_format, strtotime($transfer->created_at->toDateString()))); ?>", "<?php echo e($transfer->reference_no); ?>", "<?php echo e($status); ?>", "<?php echo e($transfer->id); ?>", "<?php echo e($transfer->fromWarehouse->name); ?>", "<?php echo e($transfer->fromWarehouse->phone); ?>", "<?php echo e($transfer->fromWarehouse->address); ?>", "<?php echo e($transfer->toWarehouse->name); ?>", "<?php echo e($transfer->toWarehouse->phone); ?>", "<?php echo e($transfer->toWarehouse->address); ?>", "<?php echo e($transfer->total_tax); ?>", "<?php echo e($transfer->total_cost); ?>", "<?php echo e($transfer->shipping_cost); ?>", "<?php echo e($transfer->grand_total); ?>", "<?php echo e($transfer->note); ?>", "<?php echo e($transfer->user->name); ?>", "<?php echo e($transfer->user->email); ?>"]'>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <button type="button" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php echo e(ucfirst(trans('file.action'))); ?><span class="caret"></span><span class="sr-only">Toggle Dropdown</span>
                                                </button>
                                                <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                                    <li>
                                                        <button type="button" class="btn btn-link view"><i class="fa fa-eye"></i> <?php echo e(ucfirst(trans('file.View'))); ?></button>
                                                    </li>
                                                    <?php if(in_array("transfers-edit", $all_permission)): ?>
                                                    <li>
                                                        <a href="<?php echo e(route('transfers.edit', $transfer->id)); ?>" class="btn btn-link"><i class="dripicons-document-edit"></i> <?php echo e(ucfirst(trans('file.edit'))); ?></a> 
                                                    </li>
                                                    <?php endif; ?>
                                                    <li class="divider"></li>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/pos.halalexportindonesia.com/project-files/resources/views/transfer/index.blade.php ENDPATH**/ ?>