...
<section>
    <div class="container-fluid">
        <?php if(in_array("transfers-add", $all_permission)): ?>
            <a href="<?php echo e(route('transfers.create')); ?>" class="btn btn-info"><i class="dripicons-plus"></i> <?php echo e(ucfirst(trans('file.add'))); ?> <?php echo e(ucfirst(trans('file.Transfer'))); ?></a>
            <a href="<?php echo e(url('transfers/transfer_by_csv')); ?>" class="btn btn-primary"><i class="dripicons-copy"></i> <?php echo e(ucfirst(trans('file.import'))); ?> <?php echo e(ucfirst(trans('file.Transfer'))); ?></a>
        <?php endif; ?>
    </div>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u5070271/files-urekapos/resources/views/transfer/index.blade.php ENDPATH**/ ?>