        ...
        <div class="row">
            <div class="col-md-12 text-right mb-4">
                @if(in_array("sales-add", $all_permission))
                    <a href="{{route('sales.create')}}" class="btn btn-info p-3"><i class="dripicons-plus"></i> {{trans('file.Add Sale')}}</a>&nbsp;
                    <a href="{{url('sales/sale_by_csv')}}" class="btn btn-primary p-3"><i class="dripicons-copy"></i> {{trans('file.Import Sale')}}</a>
                @endif
            </div>
            <div class="col-md-12">
                <div class="card">
                            ...
                            <table id="sale-table" class="table sale-list" style="width: 100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th>{{ucfirst(trans('file.Sale Status'))}}</th>
                                        <th>{{ucfirst(trans('file.Payment Status'))}}</th>
    ...
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            <div class="container mt-3 pb-2 border-bottom">
                <div class="row">
                    <div class="col-md-3">
                        <button id="print-btn" type="button" class="btn btn-default btn-sm d-print-none"><i class="dripicons-print"></i> {{ucfirst(trans('file.Print'))}}</button>
                        
                        {{ Form::open(['route' => 'sale.sendmail', 'method' => 'post', 'class' => 'sendmail-form'] ) }}
                            <input type="hidden" name="sale_id">
                            <button class="btn btn-default btn-sm d-print-none"><i class="dripicons-mail"></i> {{ucfirst(trans('file.Email'))}}</button>
                        {{ Form::close() }}
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-12 text-center">
                        <i style="font-size: 15px;">{{ucfirst(trans('file.Sale Details'))}}</i>
                    </div>
                </div>
            </div>
    ...
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 id="exampleModalLabel" class="modal-title">{{ucwords(trans('file.All'))}} {{ucwords(trans('file.Payment'))}}</h5>
...
<div id="add-payment" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 id="exampleModalLabel" class="modal-title">{{ucwords(trans('file.Add Payment'))}}</h5>
                <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
            </div>
            <div class="modal-body">
...
<div id="edit-payment" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 id="exampleModalLabel" class="modal-title">{{ucwords(trans('file.Update Payment'))}}</h5>
                <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
            </div>
            <div class="modal-body">
                {!! Form::open(['route' => 'sale.update-payment', 'method' => 'post', 'class' => 'payment-form' ]) !!}
                    ...
                    <div class="text-right">
                        <button type="submit" class="btn btn-primary btn-md-block">{{ucfirst(trans('file.update'))}}</button>
                    </div>
...
<div id="add-delivery" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 id="exampleModalLabel" class="modal-title">{{ucwords(trans('file.Add Delivery'))}}</h5>
                <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
            </div>
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-6 form-group">
                        <label>{{ucwords(trans('file.Delivery Reference'))}}</label>
                        <p id="dr"></p>
                    </div>
                    <div class="col-md-6 form-group">
                        <label>{{ucwords(trans('file.Sale Reference'))}}</label>
                        <p id="sr"></p>
                    </div>
                    <div class="col-md-12 form-group">
                        <label>{{ucwords(trans('file.Status'))}} *</label>
                    ...
                    <div class="col-md-6 mt-2 form-group">
                        <label>{{ucwords(trans('file.Delivered By'))}}</label>
                    ...
                    <div class="col-md-6 form-group">
                        <label>{{ucwords(trans('file.Attach File'))}}</label>
