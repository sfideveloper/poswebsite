            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4><?php echo e(ucwords(trans('file.Add User'))); ?></h4>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><strong><?php echo e(ucwords(trans('file.UserName'))); ?> *</strong></label>
                                    ...
                                    <div class="form-group">
                                        <label><strong><?php echo e(ucwords(trans('file.Password'))); ?> *</strong></label>
                                    ...
                                    <div class="form-group">
                                        <label><strong><?php echo e(ucwords(trans('file.Email'))); ?> *</strong></label>
                                    ...
                                    <div class="form-group">
                                        <label><strong><?php echo e(ucwords(trans('file.Phone Number'))); ?> *</strong></label>
                                    ...
                                    <div class="customer-section">
                                        <div class="form-group">
                                            <label><strong><?php echo e(ucwords(trans('file.Address'))); ?> *</strong></label>
                                            <input type="text" name="address" class="form-control customer-input">
                                        </div>
                                        <div class="form-group">
                                            <label><strong><?php echo e(ucwords(trans('file.State'))); ?></strong></label>
                                            <input type="text" name="state" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label><strong><?php echo e(ucwords(trans('file.Country'))); ?></strong></label>
                                            <input type="text" name="country" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <input class="mt-2" type="checkbox" name="is_active" value="1" checked>
                                        <label class="mt-2"><strong><?php echo e(ucwords(trans('file.Active'))); ?></strong></label>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><strong><?php echo e(ucwords(trans('file.Company Name'))); ?></strong></label>
                                        <input type="text" name="company_name" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        <label><strong><?php echo e(ucwords(trans('file.Role'))); ?> *</strong></label>
                                    ...
                                    <div class="customer-section">
                                        <div class="form-group">
                                            <label><strong><?php echo e(ucwords(trans('file.Customer Group'))); ?> *</strong></label>
                                        ...
                                        <div class="form-group">
                                            <label><strong><?php echo e(ucwords(trans('file.name'))); ?> *</strong></label>
                                            <input type="text" name="customer_name" class="form-control customer-input">
                                        </div>
                                        <div class="form-group">
                                            <label><strong><?php echo e(ucwords(trans('file.Tax Number'))); ?></strong></label>
                                            <input type="text" name="tax_number" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label><strong><?php echo e(ucwords(trans('file.City'))); ?> *</strong></label>
                                            <input type="text" name="city" class="form-control customer-input">
                                        </div>
                                        <div class="form-group">
                                            <label><strong><?php echo e(ucwords(trans('file.Postal Code'))); ?></strong></label>
                                            <input type="text" name="postal_code" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group" id="biller-id">
                                        <label><strong><?php echo e(ucwords(trans('file.Biller'))); ?> *</strong></label>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/pos.halalexportindonesia.com/project-files/resources/views/user/create.blade.php ENDPATH**/ ?>