    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12 text-right mb-4">
                <button class="btn btn-info p-3" data-toggle="modal" data-target="#createModal"><i class="dripicons-plus"></i> <?php echo e(ucfirst(trans('file.Count Stock'))); ?> </button>
            </div>
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                            ...
                            <table id="stock-count-table" class="table stock-count-list">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="not-exported"><?php echo e(ucfirst(trans('file.Initial File'))); ?></th>
                                        <th class="not-exported"><?php echo e(ucfirst(trans('file.Final File'))); ?></th>
    ...
    <div role="document" class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h5 id="exampleModalLabel" class="modal-title"><?php echo e(ucwords(trans('file.Count Stock'))); ?></h5>
          ...
          <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
            <div class="row">
                ...
                <div class="col-md-6 form-group" id="category">
                    <label><?php echo e(ucwords(trans('file.category'))); ?></label>
                ...
                <div class="col-md-6 form-group" id="brand">
                    <label><?php echo e(ucwords(trans('file.Brand'))); ?></label>
...
<div id="finalizeModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
  <div role="document" class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h5 id="exampleModalLabel" class="modal-title"><?php echo e(ucwords(trans('file.Finalize Stock Count'))); ?></h5>
        <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
      </div>
        <div class="modal-body">
            ...
            <div class="form-group">
                <label><?php echo e(ucwords(trans('file.Upload File'))); ?> *</label>
            ...
            <div class="container mt-3 pb-3">
                ...
                <table class="table table-bordered stockdif-list">
                    <thead>
                        ...
                        <th><?php echo e(ucfirst(trans('file.Expected'))); ?></th>
                        <th><?php echo e(ucfirst(trans('file.Counted'))); ?></th>
                        <th><?php echo e(ucfirst(trans('file.Difference'))); ?></th>
                        <th><?php echo e(ucfirst(trans('file.Cost'))); ?></th>
                    </thead>
                    <tbody>
                    </tbody>
                </table>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/customer/www/pos.halalexportindonesia.com/project-files/resources/views/stock_count/index.blade.php ENDPATH**/ ?>