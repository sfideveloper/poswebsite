                ...
                <div class="row">
                    ...
                    <div class="col-md-6" id="closing-section">
                        <form action="<?php echo e(route('cashRegister.close')); ?>" method="POST">
                            ...
                            <button type="submit" class="btn btn-primary" onclick="return confirmClose()"><?php echo e(ucfirst(trans('file.Close Register'))); ?></button>
                        </form>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u5070271/files-urekapos/resources/views/cash_register/index.blade.php ENDPATH**/ ?>